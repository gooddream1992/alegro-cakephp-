    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                $htl_fixrm_pric = $this->User->getHotelfixprice($fstHotel->property_id, $guest);
                ?>
            </div>
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="aparthotel-main">
                        ...
                        <div class="Credit-Card">
                            ...
                            <ul class="cardTipe">
                                <li style="width: 18%;" onclick="checkImg('proxypay', '#m_img1', '#m_img2, #m_img3, #m_img4');">
                                    ...
                                    <img src="<?= $this->Url->image('multicaixa.png'); ?>" alt="">
                                </li>
                    ...
                    <div class="aparthotel-right">
                        <div class="aparthotel-right-box"><i class="fa fa-bell"></i><?= __("Only"); ?> <b><?= $RmDet->room_count; ?> <?= ($RmDet->room_count > 1) ? __('rooms') : __('room'); ?></b> <?= __("left at this price!"); ?></div>
                        <div class="aparthotel-right-box2">
                            <div class="bedroom-apartment">
                                <div class="aparthotel-right-text "><?= $RmDet->bed_name; ?></div>
                                ...
                                <h6>
                                    ...
                                    <?php
//pj($aminity);
                                    $aminity = $this->User->propertyAmenitiesRoom($fstHotel->id);
                                    $aminityx = [];
                        ...
                        <div class="aparthotel-best-price">
                            ...
                            <p><?= __("Alegro coupons are not eligible on reservations where hotels process the payment."); ?></p>
                            <p><?= __("Prices are in"); ?> Kwanzas</p>
                        </div>
                    </div>
                </div>
            </div>
