                    ...
                    <tr>
                        <td style="text-align: center;">
                            <div style="margin-top: 25px; border-bottom:1px solid #000;float: left; width: 100%; padding-bottom: 10px;">
                                <h5 style=" margin: 0; text-align:left; color: #ccc; font-size: 16px; float: left; width: 70%; font-weight: normal;">Due Date: <span style="color: #000;">' . date_format($bookingdetails->purches_date, "d M Y") . '</span></h5>
                    ...
                    <tr>
                        <td style="text-align: center;">
                            <div style="float: right; width: 30%; padding-bottom: 10px;">
                                <p style="color: #6b6b6b; font-weight: normal; text-align: left; line-height: 22px;"><span style="font-weight: bold; color: #000;">' . $userdetails->first_name . " " . $userdetails->sur_name . '</span><br> ' . $userdetails->province . ',' . $userdetails->country . '<br>' . $userdetails->phone_number . '<br>' . $usermail->email . '<br>Attan: ' . $userdetails->first_name . " " . $userdetails->sur_name . '</p>
                            </div>
                        </td>
                    </tr>
                </table>
        ...
        if ($this->request->is(['post'])) {
            ...
            if ($data['email'] == "") {
                ...
                if ($users->count() > 0) {
                    ...
                    $from = $fromvalue->value;
                    $subject = $emailTemplate->display;
                    $link = '<a style="text-decoration:none;color:black;" target="_blank" href=' . HTTP_ROOT . 'change-password/' . $user->unique_id . '>Reset Password</a>';
            ...
            if ($this->Shareinfo->save($datasave)) {
                ...
                if (!empty($retn_dtim)) {
                    ...
                    $message = '<style type="text/css">
                      ...
                      <h4 style="font-size: 18px; margin-top: 14px; margin-bottom: 0;">Get Your Travel Started</h4>
                      </td>
                      </tr>
                      <tr>
                      <td style=" padding: 10px 15px;">
                      <p>' . $name . '</p>
                      <p>Take a look at this travel information</p>
                      <p>Buy this</p>
                      </td>
                      </tr>
                      <tr>
                      ...
                      <h4 style="margin: 13px 0 0 0;">' . $share_data->cabin . '</h4>
                      </div>
                      </td>
                      </tr>
                      <tr>
                      ...
                      <p><strong style="margin-bottom: 10px; display: inline-block;">' . $dep_dtim->format('l') . '</strong><br>' . $dep_dtim->format('d M, Y') . '</p>
                      </div>
                      ...
                      <p style=" margin:5px 0; font-size: 15px;">' . $dep_dtim->format('H:i A') . '</p>
                      <h5 style="margin: 0; font-size: 18px;">' . $ori_dat->city . '</h5>
                      <p style=" margin:5px 0; font-size: 15px;">' . $ori_dat->country . '</p>
                      </li>
                      ...
                      <li style="float: left; width: 25%">
                      <p style=" margin:5px 0; font-size: 15px;">' . $dep_arr_dtim->format('H:i A') . '</p>
                      <h5 style="margin: 0; font-size: 18px;">' . $desti_dat->city . '</h5>
                      <p style=" margin:5px 0; font-size: 15px;">' . $desti_dat->country . '</p>
                      </li>
                      </ul>
                      <ul style="float: left; width: 100%; padding: 0; list-style-type: none;">
                      <li style="float: left;">
                      <img style="width:45px;" src="' . HTTP_ROOT . 'img/emailtemp/sit.png" alt="">
                      <p style="font-size: 15px;">' . $share_data->start_d_airline_name . '-' . $share_data->start_d_airline_num . '</p>
                      </li>
                      <li style=" float: right; width: 80%;">
                      <h5 style="margin-top: 0; font-size: 18px; margin-bottom: 10px;">' . $dep_dtim->diff($dep_arr_dtim)->format('%d d %H h %i m') . '</h5>
                      <p style="font-size: 15px; margin: 0;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum</p>
                      </li>
                      </ul>
                      <img style="width: 50px;" src="' . HTTP_ROOT . 'img/emailtemp/wrong-icon.png" alt="">
                      <p style="margin-top: 2px; font-size: 15px;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been</p>
                      </div>
                      </td>
                      </tr>
                      <tr>
                      ...
                      <h4 style="float:left; margin:12px 0 0 15px; ">Return</h4>
                      </div>
                      </td>
                      </tr>
                      <tr>
                      <td>
                      <div style="float: left; width: 17%;">
                      <p><strong style="margin-bottom: 10px; display: inline-block;">' . $retn_dtim->format('l') . '</strong><br>' . $retn_dtim->format('d M, Y') . '</p>
                      </div>
                      <div style=" float: right; width: 76%; border-left: 1px solid #ccc; padding-left: 26px;">
                      <ul style="list-style-type: none;float: left; width: 100%; padding: 0;">
                      <li style="float: left; width: 25%">
                      <p style=" margin:5px 0; font-size: 15px;">' . $retn_dtim->format('H:i A') . '</p>
                      <h5 style="margin: 0; font-size: 18px;">' . $desti_dat->city . '</h5>
                      <p style=" margin:5px 0; font-size: 15px;">' . $desti_dat->country . '</p>
                      </li>
                      <li style="float: left; width: 25%; text-align: center; padding-top: 25px;"><img style="width: 50px;" src="' . HTTP_ROOT . 'img/emailtemp/plain-icon-2.png" alt=""></li>
                      ...
                      <li style="float: left;">
                      <img style="width:45px;" src="' . HTTP_ROOT . 'img/emailtemp/sit.png" alt="">
                      <p style="font-size: 15px;">' . $share_data->return_d_airline_name . '-' . $share_data->return_d_airline_num . '</p>
                      </li>
                      <li style=" float: right; width: 80%;">
                      <h5 style="margin-top: 0; font-size: 18px; margin-bottom: 10px;">' . $retn_dtim->diff($retn_arr_dtim)->format('%d d %H h %i m') . '</h5>
                      <p style="font-size: 15px; margin: 0;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum</p>
                      </li>
                      </ul>
                      <img style="width: 50px;" src="' . HTTP_ROOT . 'img/emailtemp/wrong-icon.png" alt="">
                      ...
                      <li style="float: left; width: 100%; border-bottom: 1px solid #ccc; padding: 20px 0;"><h3 style="float: left; margin: 0;">Fare Summary</h3> <span style="float: right;">' . $share_data->passengers . ' Passenger</span></li>
                      <li style="float: left; width: 100%; border-bottom: 1px solid #ccc; padding: 20px 0;"><p style=" margin: 0; float: left;">Air Transportation Charges </p><span style="float: right;"> ' . number_format((($price1 * 2) * $share_data->passengers), 2) . ' AOA</span></li>
                      <li style="float: left; width: 100%; border-bottom: 1px solid #ccc; padding: 20px 0;"><p style="margin: 0; float: left;">Taxes, Fees and Chages </p><span style="float: right;"> ' . number_format($service_fee1, 2) . ' AOA</span></li>
                      <li style="float: left; width: 100%; padding: 20px 0;"><p style="margin: 0; float: left; font-weight: bold;">GRAND TOTAL- </p><span style="float: right; font-weight: bold;">' . number_format($total_peice, 2) . ' AOA</span></li>
                      </ul>
                      </td>
                      </tr>
                      <tr>
                      <td style="padding-bottom: 30px;">
                      <a style="float: left; background: #ccc; padding: 17px 20px; color: #000; text-decoration: none;" href="#">Prices and availability are subject to change</a>
                      <a style="float: right; padding: 17px 32px; text-decoration:none; background: #f1c400; color: #000; text-transform: uppercase; font-size: 15px;" href="' . HTTP_ROOT . 'route-review/' . $data['ref_id'] . '/share">Book Now</a>
                      </td>
                      </tr>
                      <tr style="background-color: #f1c400; padding-top: 30px;">
                      <td style=" padding: 14px; margin-top: 30px;">
                      <p style="float: left; margin: 13px 0 0;">Contact Us - 1234567890</p>
                    ...
                    $message = '<style type="text/css">
                      ...
                      <ul style="padding: 0; margin: 20px 0 0 0; float: left; width: 100%; list-style-type: none;">
                      <li style="float: left; width: 100%; border-bottom: 1px solid #ccc; padding: 20px 0;"><h3 style="float: left; margin: 0;">Fare Summary</h3> <span style="float: right;">' . $share_data->passengers . ' Passenger</span></li>
                      <li style="float: left; width: 100%; border-bottom: 1px solid #ccc; padding: 20px 0;"><p style=" margin: 0; float: left;">Air Transportation Charges </p><span style="float: right;"> ' . number_format((($price1) * $share_data->passengers), 2) . ' AOA</span></li>
                      <li style="float: left; width: 100%; border-bottom: 1px solid #ccc; padding: 20px 0;"><p style="margin: 0; float: left;">Taxes, Fees and Chages </p><span style="float: right;"> ' . number_format($service_fee1, 2) . ' AOA</span></li>
                      <li style="float: left; width: 100%; padding: 20px 0;"><p style="margin: 0; float: left; font-weight: bold;">GRAND TOTAL- </p><span style="float: right; font-weight: bold;">' . number_format($total_peice, 2) . ' AOA</span></li>
                      </ul>
                      </td>
