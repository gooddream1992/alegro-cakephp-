...
?>
    ...
    <div class="top-last" style="color: #7b7b7b;text-align:  center; font-weight: bold;">
        ...
        <span style="font-size: 2rem;"><?= __(date("D, d M", strtotime(str_replace(',', ' ', $fligh_det['start_depart_time'])))); ?> <?php if (!empty($fligh_det['return_arrival_time'])){ ?>- <?= __(date("D, d M", strtotime(str_replace(',', ' ', $fligh_det['return_arrival_time'])))); ?> <?php } ?></span>
        <br>      
        <span style="font-size: 20px;"><?php echo $fligh_det['passengers']; echo ($fligh_det['passengers']>1)?" Passenges":" Passenger"; ?></span>
...
<?php 
        ...
        foreach($full_det as $resut){                        
                            ...
                            if($resut->jor_typ == "Journey Details Start"){ $jor_st_cn++;}
                            if($resut->jor_typ == "Journey Details Return"){ $jor_ed_cn++;}
                        }
            ?>
                    ...
                    <div class="searchItem_2 d-flex">
                       ...
                       <div class="details desktop">
                            ...
                            <table class="line line-1">
                                <tbody><tr>
                                    ...
                                    <td rowspan="2">
                                        ...
                                        <div class="<?php if($jor_st_cn <= 0){ echo "Direct";}else{echo $jor_st_cn ;}?> stopsRange" disabled></div>
                                        <p class="citationStops"><?php if($jor_st_cn <= 0){ echo "Direct";}else{echo $jor_st_cn;}?> <?php if($jor_st_cn==1){echo "stop";}if($jor_st_cn>1){echo "stops";} ?></p>
                                    </td>
                            ...
                            <table class="line line-2">
                                <tbody><tr>
                                    ...
                                    <td rowspan="2">
                                        ...
                                        <div class="<?php if($jor_ed_cn <= 0){ echo "Direct";}else{echo $jor_ed_cn ;}?> stopsRange" disabled></div>
                                        <p class="citationStops"><?php if($jor_ed_cn <= 0){ echo "Direct";}else{echo $jor_ed_cn ;}?> <?php if($jor_ed_cn==1){echo "stop";}if($jor_ed_cn>1){echo "stops";} ?></p>
                                    </td>
                                    <td class="time-desktop-3">
                        ...
                        <div class="bookBtn text-center">
                            <span><?=$flightPrice['total_peice'];?> AOA</span>
                            <button href="#" data-toggle="modal" data-target="#flightDetailsModal" class="btn active" style="background: #f9d749;"><?php echo __('Booked');?></button>
                        </div>
                    </div>
