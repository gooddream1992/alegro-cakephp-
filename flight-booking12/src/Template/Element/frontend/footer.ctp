        ...
        <div class="row text-center text-md-left">
            <div class="col-sm-12 col-md-3">
                ...
                <div class="footer-text footer-text-logo">
                    <?php echo __('Lorem ipsum dolor sit amet, consectetur adipiscing sed do eiusmod tempor incididunt'); ?>
                </div>
                <div class="social-logos">
                    <ul class="list-inline color-white">
                        ...
                        <li class="list-inline-item">
                            <a  target="_blank" href="https://plus.google.com/u/0/115983695915551381746">
            ...
            <div class="col-6 col-md-2 offset-xl-1">
                ...
                <div class="footer-menu-links-list footer-text">
                    <ul>
                        <li>
                            <a href="<?php echo HTTP_ROOT.'about-us'?>"><?php echo __('About');?></a>
                        </li>
                        <li>
                            <a href="#"><?php echo __('Blog');?></a>
                        </li>
                        <li>
                            <a href="<?php echo HTTP_ROOT.'contact-us'?>"><?php echo __('Contacts');?></a>
                        </li>
                        <li>
                            <a href="#"><?php echo __('Page');?></a>
                        </li>
                        <li>
                            <a href="<?=HTTP_ROOT;?>extranets"><?php echo __('Extranet portal');?></a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-6 col-md-2">
                ...
                <div class="footer-menu-links-list footer-text">
                    <ul>
                        <li>
                            <a href="#"><?php echo __('Sticky Post');?></a>
                        </li>
                        <li>
                            <a href="#"><?php echo __('Gallery Post');?></a>
                        </li>
                        <li>
                            <a href="#"><?php echo __('Quote Post');?></a>
                        </li>
                        <li>
                            <a href="#"><?php echo __('Video Post');?></a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-6 col-md-2">
                ...
                <div class="footer-menu-links-list footer-text">
                    <ul>
                        <li>
                            <a href="#"><?php echo __('Support');?></a>
                        </li>
                        <li>
                            <a href="#"><?php echo __('Partners');?></a>
                        </li>
                        <li>
            ...
            <div class="col-6 col-md-3 col-xl-2">
                ...
                <div class="footer-menu-links-list footer-text">
                    <ul>
                        <li>
                            <a href="#"><?php echo __('Convenience Options');?></a>
                        </li>
                        <li>
                            <a href="#"><?php echo __('Privilege Pass');?></a>
                        </li>
                        <li>
                            <a href="#"><?php echo __('On-time Guarantee');?></a>
                        </li>
                        <li>
                            <a href="#"><?php echo __('Flyplan Account');?></a>
                        </li>
                    </ul>
                </div>
            </div>
