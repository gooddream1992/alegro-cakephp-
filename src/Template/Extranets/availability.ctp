            ...
            <div class="col-md-10">
                ...
                <div class="head-section" id="msform">
                    ...
                    foreach ($availableBeds as $bes) {
                        ...
                        if ($this->User->getBookingRoomType($id) == 1) {
                            $propAvailability = $this->User->availlity($id, 0);
                            ?>
                            <input type="hidden" name="sub_id<?= $coun; ?>" value="0">
                            <?php
                        } else {
                        ...
                        <fieldset id="f<?= $coun; ?>">
                            ...
                            <div class="card-page-header row">
                                <div class="m-t-8 m-b-8">
                                    <h2><?php echo __('Declare the availability of your'); ?> <?php
                                        if ($this->User->getBookingRoomType($id) == 1) {
                                            echo $this->User->getProName($id);
                                        } else {
                                            echo $bes->bed_name;
                                        }
                                        ?></h2>
                                            ...
                                            <div class="regular-radio allow-book-instantly-radio radio-selected radio">
                                                <label class="radio-besic" title="">
                                                    ...
                                                    <div class="p-l-2">
                                                        ...
                                                        <div><?php echo __('Guests can book'); ?> <?php
                                                            if ($this->User->getBookingRoomType($id) == 1) {
                                                                echo $this->User->getProName($id);
                                                            } else {
                                                                echo $bes->bed_name;
                                                            }
                                                            ?> <?php echo __('without sending a reservation request.'); ?></div>
                                                    </div>
                                                </label>
                                            </div>
                                            <div class="regular-radio require-reservation-requests-radio radio">
                                                <label class="radio-besic" title="">
                                                    ...
                                                    <div class="p-l-2">
                                                        ...
                                                        <div><?php echo __('Guests wishing to book'); ?> <?php
                                                            if ($this->User->getBookingRoomType($id) == 1) {
                                                                echo $this->User->getProName($id);
                                                            } else {
                                                                echo $bes->bed_name;
                                                            }
                                                            ?> <?php echo __('must send a reservation request. I understand that this may reduce the number of bookings I receive.'); ?></div>
                                                    </div>
                                                </label>
                                            </div>
                                        </div>
                            ...
                            <div class="availability">
                                <h2><?php echo __('How many days into the future can guests book'); ?> <?php
                                    if ($this->User->getBookingRoomType($id) == 1) {
                                        echo $this->User->getProName($id);
                                    } else {
                                        echo $bes->bed_name;
                            ...
                            <div class="availability">
                                ...
                                <div class="quantity-section">
                                    ...
                                    <div class="inner-quantity-section">
                                        ...
                                        <p onclick="$('#max_ni8_1').click();">
                                            <label class="radio-besic" style="font-weight: normal;font-size: 14px;">
                                            <input type="radio" id="max_ni8_1" name="max_night<?= $coun; ?>" value="1" <?php
                                                ...
                                                ?>> 
                                                <span class="checkmark"></span>
                                                <?php echo __('No maximum nights per stay'); ?>
                                                </label>
                                            </p>

                                        <label class="radio-besic">
                                                    ...
                                                    <div class="p-l-2">
                                                        <span>
                                                            <div><?php
                                                                ...
                                                                ?> <?php echo __('is available for booking on any day.'); ?></div>
                                                        </span>
                                                    </div>
                                                </label>
                                            </div>
                                                    ...
                                                    <div class="p-l-2">
                                                        <span>
                                                            <div>
                                                                ...
                                                                ?> <?php echo __('is unavailable for booking on certain days.'); ?>
                                                            </div>
                                                        </span>
