...
<?php /* ?><div class="se-pre-con" style="display: none"> 
    <div class="top-end">
        ...
        <div class="img-load-ing">
            ...
            <center>
                <span id="loader-text" style=" font-size: 2em;">
...
<div class="se-pre-con1" style="display: none"> 
    <div class="top-end">
        <?php echo $this->element('frontend/login-header'); ?>
        <div class="img-load-ing">
            <img style="margin-bottom: 40px;" src="<?= $this->Url->image('hotel.png'); ?>" alt="" width="170">
            <center>
                <span  style=" font-size: 2em;">
                    <?php echo __('Searching for hotels') ?>                     
                </span>
            </center>
        </div> 
    </div> 
...
<section id="cta" data-slides='["<?php echo HTTP_ROOT ?>img/cta_bg1.jpg", "<?php echo HTTP_ROOT ?>img/cta_bg2.jpg", "<?php echo HTTP_ROOT ?>img/cta_bg3.jpg", "<?php echo HTTP_ROOT ?>img/cta_bg4.jpg", "<?php echo HTTP_ROOT ?>img/cta_bg5.jpg", "<?php echo HTTP_ROOT ?>img/cta_bg6.jpg"]'>
