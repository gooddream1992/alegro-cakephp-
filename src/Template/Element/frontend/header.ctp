    ...
    <nav class="navbar navbar-expand-lg navbar-light navbar-trans">
        ...
        <div class="collapse navbar-collapse" id="navmenu2">
            ...
            <ul class="navbar-nav">
                ...
                <!--
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo HTTP_ROOT . 'my-booking?q=a' ?>">MY BOOKINGS</a>
                </li>
                -->
                ...
                <?php if ($this->request->getSession()->read('Auth.User.id')) { ?>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="profileDropdownMenuLink">
                            ...
                            <a class="dropdown-item" href="<?php echo HTTP_ROOT . 'my-booking?q=a' ?>"><?php echo __('My Bookings') ?></a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <!--</div>-->
                    <div class="dropdown-menu" aria-labelledby="profileDropdownMenuLink">
                        <a class="dropdown-item <?php if($this->request->session()->read("CURRENCY") == "AOA") { ?> active <?php } ?>" href="#">kz (AOA)</a>
                    </div>
                </li> 

                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-globe" aria-hidden="true"></i> 
                        <?php
