...
<div style="margin: 0 auto; padding: 0; width: 900px; max-width: none; box-sizing: border-box; font-family: Verdana, Geneva, sans-serif;">
 ...
 <div style="padding: 20px; margin: 0; width: 100%; background: #FFF; float: left; box-sizing: border-box;">
  ...
  <div style="margin-bottom: 20px; padding: 0; box-sizing: border-box; width: 700px; border: 1px dashed #e5e5e5; float: left;">
   <div style="padding: 20px; margin: 0; box-sizing: border-box; width: 120px; display: flex; flex-direction: column; justify-content: center; overflow: hidden; float: left;">
    <img src="<?php echo HTTP_ROOT . COVER_PHOTO . $eventDetail->image ?>"  style="max-width: 100%;width: 100px" />
   </div>
   <div style="padding: 20px 0; margin: 0; box-sizing: border-box; width: 300px; display: flex; flex-direction: column; justify-content: center; overflow: hidden; float: left;">
   ...
   <div style="padding: 20px; margin: 0; box-sizing: border-box; width: 120px; display: flex; flex-direction: column; justify-content: center; overflow: hidden; float: left;">
    <img src="<?php echo HTTP_ROOT ?>/images/qr-code.jpg" style="max-width: 100%; width: 120px; float: right;"/>
   </div>
  </div>
  ...
  <div style=" border-bottom: 1px solid #e5e5e5; width: 100%; float: left;">
   <div style="padding: 20px 0; width: 59%; float: left; text-align:right;">
    <img src="<?php echo HTTP_ROOT ?>/images/qr-code.jpg"  style="width: 100px;"/>
   </div>
