...
<?php
$mainprice = explode("AOA", $ubd->price)[1];
if ($cabin['radio'] == "One-Way Flight") {
    $price1 = explode("AOA", $ubd->price)[1];
}
if ($cabin['radio'] == "Return Trip") {
    $price1 = explode("AOA", $ubd->price)[1] / 2;
}
?>
<style>
...
<div class="se-pre-con"> 
        ...
        <div class="img-load-ing">
            ...
            <center>
                <span style="font-size: 2em; color:#000;">
                    <?php echo __('Please wait, while we load your next trip to') ?> <b><?= __($this->User->cityHelper($ubd['destination'])->city); ?></b> (<?= __($ubd['destination']) ?>) </span>
            </center>
        </div> 
    </div> 
    ...
    <div class="top-last" style="color: #000;text-align:  center; font-weight: bold;">
        ...
        <span style="font-size: 2em; color:#7b7b7b;"><?= __(date("M", strtotime($this->Time->format($cabin['departure_date'], 'Y-MM-d')))). __(date(" d", strtotime($this->Time->format($cabin['departure_date'], 'Y-MM-d')))).','.' '. __(date("D", strtotime($this->Time->format($cabin['departure_date'], 'Y-MM-d')))); ?> <?php if (!empty($cabin['return_date'])) { ?>- <?= __(date("M", strtotime($this->Time->format($cabin['return_date'], 'Y-MM-d')))). __(date(" d", strtotime($this->Time->format($cabin['return_date'], 'Y-MM-d')))).','.' '. __(date("D", strtotime($this->Time->format($cabin['return_date'], 'Y-MM-d')))); ?> <?php } ?></span>
        <br>      
        <span style="font-size: 20px; color:#000;"><?php echo $ubd['passengers'];
                    echo ($ubd['passengers'] > 1) ? ' '. __('Passengers') : ' '.__('Passenger');
                    ?></span>
            ...
            <div class="col-sm-4 col-md-5 col-lg-4">
                <div class="row no-gutters destination-search-left-infos">
                    ...
                    <div class="col-9">
                        <div class="row">
                            <div class="col">
                                <div class="destination-search-title"> <?= __($this->User->cityHelper($ubd['origin'])->city); ?> - <?= __($this->User->cityHelper($ubd['destination'])->city); ?></div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="destination-search-subtitle"> <?= __(date("M", strtotime($this->Time->format($cabin['departure_date'], 'Y-MM-d')))). __(date(" d", strtotime($this->Time->format($cabin['departure_date'], 'Y-MM-d')))).','.' '. __(date("D", strtotime($this->Time->format($cabin['departure_date'], 'Y-MM-d')))); ?> -
                                    <?php
                                    if (isset($cabin['passenger'])) {
                                        $psn = explode(" ", $cabin['passenger'])[0];
                                        if ($psn > 1) {
                                            echo $psn . ' '. __('Passengers');
                                        } else {
                                            echo $psn . ' '. __('Passenger');
                                        }
                                    } else {
                                        echo "0".' '.__('Passenger');
                                    }
                ...
                <div class=" col-sm-4 col-md-5 col-lg-4  ">
                    <div class="row no-gutters destination-search-left-infos">
                        ...
                        <div class="col-9">
                            <div class="row">
                                <div class="col">
                                    <div class="destination-search-title"> <?= __($this->User->cityHelper($ubd['destination'])->city); ?> - <?= __($this->User->cityHelper($ubd['origin'])->city); ?> </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="destination-search-subtitle"> <?= __(date("M", strtotime($this->Time->format($cabin['return_date'], 'Y-MM-d')))). __(date(" d", strtotime($this->Time->format($cabin['return_date'], 'Y-MM-d')))).','.' '. __(date("D", strtotime($this->Time->format($cabin['return_date'], 'Y-MM-d')))); ?> - <?php
                                        if (isset($cabin['passenger'])) {
                                            $psn = explode(" ", $cabin['passenger'])[0];
                                            if ($psn > 1) {
                                                echo $psn . ' '. __('Passengers');
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group" style="margin-bottom: 0px;">
                                            ...
                                            <div class="form-control passenger-selector-toggle psngrsHow box5" data-id="1" style="margin-bottom: 0px;"><?php
                                                if (isset($cabin['passenger'])) {
                                                    $passngr = explode(" ", $cabin['passenger'])[0];
                                                    if ($passngr > 1) {
                                                        echo $passngr. ' ' . __('Passengers');
                                                    } else {
                                                        echo $passngr. ' ' . __('Passenger');
                                                    }
                                                }
                                        ...
                                        <div class="passenger-selector form-control audultSHow" style="padding-left: 0px!important;">
                                            <div style="padding: 10px">
                                                <div style="float: left">
                                                    <label style="color: #000;" href=""><?php echo __('Adults 12+') ?></label>
                                                </div>
                                            ...
                                            <div style="padding: 10px">
                                                <div style="float: left">
                                                    <label style="color: #000;"><?php echo __('Children (2-11)') ?></label>
                                                </div>
                                                <div class="rightPass" style="float: right">
                                            ...
                                            <div style="padding: 10px">
                                                <div style="float: left">
                                                    <label style="color: #000;"><?php echo __('Infants (0-2)') ?></label>
                                                </div>
                                                <div class="rightPass" style="float: right">
            ...
            <div class="col-sm-12 col-md-8 col-lg-12">
                <div class="container  bg-gris header-tab tab tab-results-mob">
                    <div class="d-table w-100 tab-title">
                        <div class="d-table-cell"><img src="<?= $this->Url->image('icon/departure.png'); ?>" width="26"> <?php echo __('Departing Flight') ?></div>
                        <div class="d-table-cell text-right p-right-10 sortby-label"><img src="https://static.thenounproject.com/png/5844-200.png" width="32"> <?= __($cabin['cabin']); ?></div>
                    </div>
                </div>
                    ...
                    <div class="details desktop">
                        <table class="line line-1">
                            <tbody><tr>
                                    ...
                                    <td>
                                        <p class="time"><?= __(date_format($ubd->start_depart_time, 'h:i A')); ?> <br> <span><?= __(date("M", strtotime($this->Time->format($ubd->start_depart_time, 'Y-MM-d')))). __(date(" d", strtotime($this->Time->format($ubd->start_depart_time, 'Y-MM-d')))).','.' '. __(date("D", strtotime($this->Time->format($ubd->start_depart_time, 'Y-MM-d')))); ?></span></p>
                                    ...
                                    <td class="time-desktop-3">
                                        <p class="time time-3"><?= __(date_format($ubd->start_arrival_time, 'h:i A')); ?> <br> <span><?= __(date("M", strtotime($this->Time->format($ubd->start_arrival_time, 'Y-MM-d')))). __(date(" d", strtotime($this->Time->format($ubd->start_arrival_time, 'Y-MM-d')))).','.' '. __(date("D", strtotime($this->Time->format($ubd->start_arrival_time, 'Y-MM-d')))); ?></span></p>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="time-mobile-3">
                                        <p class="departure"><?= __($this->User->cityHelper($ubd['origin'])->city) . ' (' . __($ubd['origin']) . ')'; ?></p>
                                    </td>

                                    <td>
                                        <p class="Arrival"><?= __($this->User->cityHelper($ubd['destination'])->city) . ' (' . __($ubd['destination']) . ')'; ?></p>
                                    </td>
                        ...
                        <table class="line">
                            <tbody><tr>
                                ...
                                <tr>
                                    ...
                                    <td class="">
                                        <p class="time"><?= __(date_format($ubd->start_arrival_time, 'h:i A')); ?> <br> <span><?= __(date("M", strtotime($this->Time->format($ubd->start_arrival_time, 'Y-MM-d')))). __(date(" d", strtotime($this->Time->format($ubd->start_arrival_time, 'Y-MM-d')))).',',' '. __(date("D", strtotime($this->Time->format($ubd->start_arrival_time, 'Y-MM-d')))); ?></span></p>
                                    </td>
                        ...
                        <span>
                            ...
                            <?php 
                                if (!empty($this->request->session()->read("CURRENCY"))) {
                                    echo $this->request->session()->read("CURRENCY").' '.number_format($this->User->priceConvert($this->request->session()->read("CURRENCY"), $price1), 2);
                                }else{
                                    echo $this->User->changeFormat(number_format($price1, 2));
                                }
                            ?>
...
<?php if (!empty($ubd->return_d_airline_name)) { ?>
                    <div class="container  bg-gris header-tab tab tab-results-mob">
                        <div class="d-table w-100 tab-title">
                            <div class="d-table-cell"><img src="<?= $this->Url->image('icon/return.png'); ?>" width="26"> <?php echo __('Return Flight') ?></div>
                            <div class="d-table-cell text-right p-right-10 sortby-label"><img src="https://static.thenounproject.com/png/5844-200.png" width="32"> <?= __($cabin['cabin']); ?></div>
                        </div>
                    </div>
                        ...
                        <div class="details desktop">
                            <table class="line line-1">
                                <tbody><tr>
                                        ...
                                        <td>
                                            <p class="time"><?= __(date_format($ubd->return_depart_time, 'h:i A')); ?> <br> <span><?= __(date("M", strtotime($this->Time->format($ubd->return_depart_time, 'Y-MM-d')))). __(date(" d", strtotime($this->Time->format($ubd->return_depart_time, 'Y-MM-d')))).','.' '. __(date("D", strtotime($this->Time->format($ubd->return_depart_time, 'Y-MM-d')))); ?></span></p>
                                        ...
                                        <td class="time-desktop-3">
                                            <p class="time time-3"><?= __(date_format($ubd->return_arrival_time, 'h:i A')); ?> <br> <span><?= __(date("M", strtotime($this->Time->format($ubd->return_arrival_time, 'Y-MM-d')))). __(date(" d", strtotime($this->Time->format($ubd->return_arrival_time, 'Y-MM-d')))).','.' '. __(date("D", strtotime($this->Time->format($ubd->return_arrival_time, 'Y-MM-d')))); ?></span></p>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="time-mobile-3">
                                            <p class="departure"><?= __($this->User->cityHelper($ubd['destination'])->city) . ' (' . __($ubd['destination']) . ')'; ?></p>
                                        </td>

                                        <td>
                                            <p class="Arrival"><?= __($this->User->cityHelper($ubd['origin'])->city) . ' (' . __($ubd['origin']) . ')'; ?></p>
                                        </td>
                            ...
                            <table class="line">
                                <tbody><tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="">
                                            <p class="time"><?= __(date_format($ubd->return_arrival_time, 'h:i A')); ?> <br> <span><?= __(date("M", strtotime($this->Time->format($ubd->return_arrival_time, 'Y-MM-d')))). __(date(" d", strtotime($this->Time->format($ubd->return_arrival_time, 'Y-MM-d')))).','.' '.__(date("D", strtotime($this->Time->format($ubd->return_arrival_time, 'Y-MM-d')))); ?></span></p>
                                        </td>
...
<?php } ?>					
                ...
                <div class="pricebreakdown">
                    <div class="container bg-gris header-tab tab tab-results-mob">
                        <div class="d-table w-100 tab-title">
                            <div class="d-table-cell"><i class="fas fa-receipt" style="font-size: 22px;"></i> <?php echo __('Price Break-Down') ?></div>
                            <div class="d-table-cell text-right p-right-12 sortby-label"><i class="fas fa-male" style="font-size: 25px;"></i> <?= explode(" ", $cabin['passenger'])[0] . " "; ?><?= (explode(" ", $cabin['passenger'])[0] > 1) ? __('Passengers') : __('Passenger'); ?></div>
                        </div>
                    </div>
                    <br>
                    <table style="margin-left: 27px;width: 645px;margin-top: -15px;">
                        ...
                        <tbody>
                            <tr style="
                                ">
                                <td style="width: 750px;border-bottom: 2px solid #eeeeee;text-transform: uppercase;font-weight:bold;padding-bottom: 10px;"><?php echo __('PRICE PER PERSON') ?></td>
                                <td style="width: 575px;border-bottom: 2px solid #eeeeee;text-transform: uppercase;font-weight:bold;"></td>
                                <td style="width: 1253px;border-bottom: 2px solid #eeeeee;text-transform: uppercase;font-weight:bold;"></td>
                                <td style="width: 253px;border-bottom: 2px solid #eeeeee;text-transform: uppercase;">
                                    <?php $priceperperson = $mainprice;
                                    
                                        if (!empty($this->request->session()->read("CURRENCY"))) {
                                            echo $this->request->session()->read("CURRENCY").' '.number_format($this->User->priceConvert($this->request->session()->read("CURRENCY"), $priceperperson), 2);
                                        }else{
                                            echo $this->User->changeFormat(number_format($priceperperson, 2));
                                        }
                            ...
                            <tr style="">
                                <td style="width: 566px;border-top: 2px solid #eeeeee;border-bottom: 1px solid #eeeeee;text-transform: uppercase;font-weight:bold;padding-top: 10px;padding-bottom: 10px;"><?php echo __('SERVICE FEE') ?></td>
                                <td style="width: 566px;border-top: 2px solid #eeeeee;border-bottom: 1px solid #eeeeee; text-transform: uppercase;font-weight:bold;"></td>
                                <td style="width: 566px;border-top: 2px solid #eeeeee;border-bottom: 1px solid #eeeeee; text-transform: uppercase;font-weight:bold;"></td>
                                <td style="width: 566px;border-top: 2px solid #eeeeee;border-bottom: 1px solid #eeeeee; text-transform: uppercase;"> <?php
                                    if ($this->User->cityHelper($ubd['origin'])->country == "Angola" && $this->User->cityHelper($ubd['destination'])->country == "Angola") {
                                        $service_fee = $servicefee->domestic * $ubd['passengers'];
                                    } else {
                                        $service_fee = $servicefee->international * $ubd['passengers'];
                                    }
                                    
                                     if (!empty($this->request->session()->read("CURRENCY"))) {
                                            echo $this->request->session()->read("CURRENCY").' '.number_format($this->User->priceConvert($this->request->session()->read("CURRENCY"), $service_fee), 2);
                                        }else{
                                            echo $this->User->changeFormat(number_format($service_fee, 2));
                                        }
                            ...
                            <tr>
                                <td style="width: 566px;border-top: 2px solid #eeeeee;border-bottom: 1px solid #eeeeee;text-transform: uppercase;font-weight:bold;padding-top: 10px;padding-bottom: 10px;"><?php echo __('TOTAL') ?></td>
                                <td style="width: 566px;border-top: 2px solid #eeeeee;border-bottom: 1px solid #eeeeee; text-transform: uppercase;font-weight:bold;"></td>
                                <td style="width: 566px;border-top: 2px solid #eeeeee;border-bottom: 1px solid #eeeeee; text-transform: uppercase;font-weight:bold;"></td>
                                <td style="width: 566px;border-top: 2px solid #eeeeee;border-bottom: 1px solid #eeeeee; text-transform: uppercase;"> <?php
                                    if ($this->User->cityHelper($ubd['origin'])->country == "Angola" && $this->User->cityHelper($ubd['destination'])->country == "Angola") {
                                        $total_peice = ($servicefee->domestic * $ubd['passengers']) + ($mainprice * $ubd['passengers']);
                                    } else {
                                        $total_peice = ($servicefee->international * $ubd['passengers']) + ($mainprice * $ubd['passengers']);
                                    }
                                    if (!empty($this->request->session()->read("CURRENCY"))) {
                                        echo $this->request->session()->read("CURRENCY").' '.number_format($this->User->priceConvert($this->request->session()->read("CURRENCY"), $total_peice), 2);
                                    }else{
                                        echo $this->User->changeFormat(number_format($total_peice, 2));
                                    }
...
//echo $total_peice ."<br>".$service_fee."<br>".$priceperperson ;
                    ...
                    <div class="col-sm-12 d-none d-sm-block" style="margin: -99px 0px 22px 478px;">
                        <a <?php
        ...
        <div class="modal-content">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><?php echo __('Share Itenerary') ?></h4>
                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 col-lg-12">
                                <div class="row">
                                    <div class="col-sm-6 ">
                                        <div class="form-group">
                                            <label for=""><?php echo __('Your Name') ?></label>
                                            <input id="user_name" type="text" class="form-control" placeholder="<?php echo __('Enter Your Name') ?>" value="<?php
                                            if (!empty($this->request->getSession()->read('Auth.User.id'))) {
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for=""><?php echo __('Email Address') ?></label>
                                            <input id="user_email" placeholder="<?php echo __('Enter Email Address') ?>" type="text" class="form-control" value="<?php
                                            if (!empty($this->request->getSession()->read('Auth.User.id'))) {
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for=""><?php echo __('Your Message') ?></label>
                                            <textarea id="user_msg" placeholder="<?php echo __('Type your message here...') ?>" type="text" class="form-control" style="height: 100px;"></textarea>
                                        </div>
                                    </div>
                                    <p style="margin: 0px 16px;color: #000000;"><span style="color: #000;font-weight: bold;"><?php echo __('Note:') ?></span> <?php echo __('To share these flights with friends and family, enter their email addresses below. Note that your email address will be included in the email we send them.') ?></p>
                                    <br>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for=""><?php echo __('Recipient 1') ?></label>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for=""><?php echo __('Recipient 2') ?></label>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary btn-continue m-top-50" data-dismiss="modal" style="margin: 0px 415px;padding: 0px 57px !important;"><?php echo __('Cancel') ?></button>
                    <button type="button" id="ShareItenerary" onclick="return shareitt()" class="btn btn-primary btn-continue m-top-50" style="margin: 0px 0px;padding: 0px 64px !important;"><?php echo __('Submit') ?></button>
                </div>
            </div>
    ...
    <div class="modal-dialog modal-confirm">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo __('Your itinerary has been shared!') ?></h4>	
            </div>
            <div class="modal-body">
                <p class="text-center"><?php echo __('Were happy you found a flight that interests you. Because prices may change, the best way to secure your fare is to book your flight right now.') ?></p>
            </div>
            <div class="modal-footer">
                <button class="btn btn-success btn-block" data-dismiss="modal" style="width: auto;"><?php echo __('Continue with your booking') ?></button>
            </div>
        </div>
    </div>
</div> 
