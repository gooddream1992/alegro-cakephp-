                                                            ...
                                                            <table align="center" border="0" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    <td align="center" class="ctaButton" style="background-color:#f9d749;padding-top:12px;padding-bottom:12px;padding-left:35px;padding-right:35px;border-radius:.25rem">
                                                                        <!-- Button Link // -->
                                                                        <a class="text" href="<?php echo HTTP_ROOT ?>" target="_blank" style="color:#000; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:13px; font-weight:700; font-style:normal;letter-spacing:1px; line-height:20px; text-transform:uppercase; text-decoration:none; display:block">
                                                                            Homepage
                                                                        </a>
                                                                    </td>
...
display: inline-block;">
                                                                        <!-- Button Link // -->
                                                                        &nbsp; &nbsp;<a class="text" href="<?php echo HTTP_ROOT.'contact-us'?>" target="_blank" style="color:#000; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:13px; font-weight:700; font-style:normal;letter-spacing:1px; line-height:20px; text-transform:uppercase; text-decoration:none; display:block">
                                                                            Contact us!
                                                                        </a>
                                                                    </td>
                                                                </tr>
