...
require_once(ROOT . '/vendor' . DS . 'Google2/src/service/Google_Model.php');
require_once(ROOT . '/vendor' . DS . 'Google2/src/service/Google_Service.php');
require_once(ROOT . '/vendor' . DS . 'Google2/src/service/Google_ServiceResource.php');
require_once(ROOT . '/vendor' . DS . 'Google2/src/auth/Google_AssertionCredentials.php');
require_once(ROOT . '/vendor' . DS . 'Google2/src/auth/Google_Signer.php');
require_once(ROOT . '/vendor' . DS . 'Google2/src/auth/Google_P12Signer.php');
require_once(ROOT . '/vendor' . DS . 'Google2/src/service/Google_BatchRequest.php');
require_once(ROOT . '/vendor' . DS . 'Google2/src/external/URITemplateParser.php');
require_once(ROOT . '/vendor' . DS . 'Google2/src/auth/Google_Auth.php');
require_once(ROOT . '/vendor' . DS . 'Google2/src/cache/Google_Cache.php');
require_once(ROOT . '/vendor' . DS . 'Google2/src/io/Google_IO.php');
require_once(ROOT . '/vendor' . DS . 'Google2/src/service/Google_MediaFileUpload.php');

require_once(ROOT . '/vendor' . DS . 'Google2/src/contrib/' . 'Google_PlusService.php');
