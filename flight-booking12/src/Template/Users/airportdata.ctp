...
if ($res_found == 0) {
    ?>
    <div class="no-result" style=" width: 70%;"><div class="no-found-logo"><img src="<?= $this->Url->image('no-result-logo.png'); ?>" alt=""></div> <h2>No Flights Available</h2><p>We could not find any flights according to your selected date. Try searching again with different dates.</p> <a href="">Change</a></div>
    <?php
} else {
    foreach ($search_det_dats as $resut) {
            ...
            <div class="details desktop">
                <table class="line line-1">
                    <tr>
                        ...
                        <td>
                            <p class="time"><?= __(date("h:i A", strtotime($this->Time->format($resut->start_depart_time, 'HH:mm:ss')))); ?><br><span><?= __(date("M d, D", strtotime($this->Time->format($resut->start_depart_time, 'Y-MM-d')))); ?></span></p>
                        ...
                        <td class="time-desktop-3">
                            <p class="time time-3"><?= __(date("h:i A", strtotime($this->Time->format($resut->start_arrival_time, 'HH:mm:ss')))); ?> <br><span><?= __(date("M d, D", strtotime($this->Time->format($resut->start_arrival_time, 'Y-MM-d')))); ?></span></p>
                        </td>
        ...
        <?php if ($fli['jor_typ'] == "Journey Details Return") { ?>
            ...
            ?>
                            ...
                            <td>
                                <p class="time"><?= __(date("h:i A", strtotime($this->Time->format($resut->return_depart_time)))); ?> <br><span><?= __(date("M d, D", strtotime($this->Time->format($resut->return_depart_time)))); ?></span></p>
                ...
                echo "stops";
                            ...
                            <td class="time-desktop-4">
                                <p class="time time-4"><?= __(date("h:i A", strtotime($this->Time->format($resut->return_arrival_time, 'HH:mm:ss')))); ?> <br><span><?= __(date("M d, D", strtotime($this->Time->format($resut->return_arrival_time, 'Y-MM-d')))); ?></span></p>
                            </td>
        ...
        <?php } ?>
            ...
            echo "stops";
                    ...
                    <tr>
                        ...
                        <td class="">
                            <p class="time"><?= __(date("h:i A", strtotime($this->Time->format($resut->start_arrival_time, 'HH:mm:ss')))); ?> <br><span><?= __(date("M d, D", strtotime($this->Time->format($resut->start_arrival_time, 'Y-MM-d')))); ?></span></p>
                        </td>
        ...
        <?php if ($fli['jor_typ'] == "Journey Details Return") { ?>
                    ...
                    <table class="line line-2">
                        <tr>
                            ...
                            <td class="">
                                <p class="time"><?= __(date("h:i A", strtotime($this->Time->format($resut->return_depart_time, 'HH:mm:ss')))); ?><br><span><?= __(date("M d, D", strtotime($this->Time->format($resut->return_depart_time, 'Y-MM-d')))); ?></span></p>
                            </td>
                            <td rowspan="2">
                                <div class="departArrivale">
                ...
                echo "stops";
                        ...
                        <tr>
                            ...
                            <td class="">
                                <p class="time"><?= __(date("h:i A", strtotime($this->Time->format($resut->return_arrival_time, 'HH:mm:ss')))); ?> <br><span><?= __(date("M d, D", strtotime($this->Time->format($resut->return_arrival_time, 'Y-MM-d')))); ?></span></p>
                            </td>
        ...
        <?php if ($resut->refundable == "true") { ?><p class="btn btn-primary"><img src="<?= $this->Url->image('dollar.png'); ?>" width="25"> Refundable</p><?php } else if ($resut->refundable == "false") { ?><p class="btn btn-primary"><img src="<?= $this->Url->image('dollar.png'); ?>" width="25"> Non-Refundable</p><?php } ?>
                ...
                <a href="#" data-toggle="modal" data-target="#flightDetailsModal<?= $resut->id; ?>" class="btn-book">Book</a>
            </div>
        </div>
                            ...
                            <div class="row flight-details-row">
                                ...
                                <div class="col-md-3 col-4 flight-details-infos text-left">
                                    ...
                                    <div class="row flight-details-date">
                                        <div class="col"> <?= __(date("M d, D", strtotime($this->Time->format($fli_de['dep_time'], 'Y-MM-d')))); ?>, <?= __(date("h:i A", strtotime($this->Time->format($fli_de['dep_time'], 'HH:mm:ss')))); ?> </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="col-md-3 col-4 flight-details-infos text-right">
                                    ...
                                    <div class="row flight-details-date">
                                        <div class="col"> <?= __(date("M d, D", strtotime($this->Time->format($fli_de['arr_time'], 'Y-MM-d')))); ?>, <?= __(date("h:i A", strtotime($this->Time->format($fli_de['arr_time'], 'HH:mm:ss')))); ?> </div>
                                    </div>
                                    <div class="row">
            ...
            ?>
                            <div class="row flight-details-row">
                                ...
                                <div class="col-md-3 col-4 flight-details-infos text-left">
                                    ...
                                    <div class="row flight-details-date">
                                        <div class="col">  <?= __(date("M d, D", strtotime($this->Time->format($fli_re['dep_time'], 'Y-MM-d')))); ?>, <?= __(date("h:i A", strtotime($this->Time->format($fli_re['dep_time'], 'HH:mm:ss')))); ?> </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="col-md-3 col-4 flight-details-infos text-right">
                                    ...
                                    <div class="row flight-details-date">
                                        <div class="col"> <?= __(date("M d, D", strtotime($this->Time->format($fli_re['arr_time'], 'Y-MM-d')))); ?>, <?= __(date("h:i A", strtotime($this->Time->format($fli_re['arr_time'], 'HH:mm:ss')))); ?> </div>
                                    </div>
                                    <div class="row">
