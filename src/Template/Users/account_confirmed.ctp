        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="main-cta text-center">
                    <h1><?= __("Search For Cheap Flights"); ?></h1>
                    <h3><?= __("THE BEST WAY TO BUY CHEAP AIR TICKETS"); ?></h3>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-confirm">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= __("All Set!"); ?></h4>	
            </div>
            <div class="modal-body">
                <p class="text-center"><?= __("Your account has been successfully confirmed. You can now log into your Alegro account."); ?></p>
            </div>
            <div class="modal-footer">
                <button class="btn btn-success btn-block" onclick='window.location.href="<?php echo(HTTP_ROOT)?>"'><?= __("OK"); ?></button>
            </div>
        </div>
    </div>
</div> 