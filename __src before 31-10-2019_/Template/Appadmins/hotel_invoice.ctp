                ...
                <td style="text-align: center;">
                    <div style="float: left; width: 30%; padding-bottom: 10px;">
                        <p style="color: #000; font-weight: normal; text-align: left; line-height: 22px;"><span style="font-weight: bold; color: #000;">Invoice: <span style="font-weight:normal;">ALE36527</span></span>
                            <br> <b>Property Type:</b> <span style="font-weight:normal;">Apartment</span>
                            <br> <b>Property Name:</b> <span style="font-weight:normal;">Hotel Rafael</span>
                            <br> <b>Location:</b> <span style="font-weight:normal;">Luanda</span>
                            <br> <b>Guests:</b> <span style="font-weight:normal;">3</span>
                            <br> <b>Check-in Date:</b> <span style="font-weight:normal;">11 Nov 2018</span>
                            <br> <b>Check-out Date:</b> <span style="font-weight:normal;">12 Jan 2019</span></p>
                    </div>
                </td>
            </tr>
            <tr>
