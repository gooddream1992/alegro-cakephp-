                        ...
                        <div class="reservation-headbox-laft">
                            ...
                            <div class="reserva-box-right">
                                ...
                                <ul>
                                    ...
                                    <li><?= __("Alegro Commission"); ?>: <span><?= @$all_data->service_fee; ?>% (AOA <?= changeFormat(number_format($all_data->total_room_fee * ($all_data->service_fee / 100), 2)); ?>)</span> </li>
                    ...
                    <div class="reservation-headbox-right">
                        ...
                        <div class="upd-res">
                            ...
                            <div class="upd-res-box">
                                <ul>
                                    <li <?php if ($all_data->user_htl_reach_status == 4) { ?> style="background:#f9d749;" <?php } ?> <?php if (($all_data->payment_status == 4) || ($all_data->user_htl_reach_status == 2) || ($all_data->user_htl_reach_status == 1) || ($all_data->user_htl_reach_status == 4) ) { ?> class= 'disabled' <?php } ?>><a <?php if ($all_data->payment_status != 4) { ?> data-toggle="modal" data-target="#myModal1a" <?php } ?> ><?= __("Change Booking Dates"); ?></a></li>
                                    
                                    <li <?php if (($all_data->payment_status == 4) || ($all_data->user_htl_reach_status == 2) || ($all_data->user_htl_reach_status == 1) || ($all_data->user_htl_reach_status == 4) ) { ?> class= 'disabled' <?php } ?>  <?php if ($all_data->user_htl_reach_status == 1) { ?> style="background:#f9d749;" <?php } ?>><a   <?php if ($all_data->payment_status != 4) { ?> data-toggle="modal" data-target="#myModal4ad" <?php } ?>><?php if ($all_data->user_htl_reach_status == 1) { echo  __("Marked As No-Show"); }else{ echo  __("Mark As No-Show");} ?></a></li>
                                    
                                    <li  <?php if (($all_data->payment_status == 4) || ($all_data->user_htl_reach_status == 2) || ($all_data->user_htl_reach_status == 1) || ($all_data->user_htl_reach_status == 4) ) { ?> class= 'disabled' <?php } ?> <?php if ($all_data->user_htl_reach_status == 2) { ?> style="background:#f9d749;" <?php } ?>><a  <?php if ($all_data->payment_status != 4) { ?>  data-toggle="modal" data-target="#myModal3ad" <?php } ?>><?php if ($all_data->user_htl_reach_status == 2) { echo  __("Marked As Show"); }else{ echo  __("Mark As Show");} ?></a></li>
                                    
                                    <?php if (($all_data->payment_status == 4) || ($all_data->user_htl_reach_status == 1) ) { ?>                                    
                                        <li <?php if ($all_data->user_htl_reach_status == 5) { ?> style="background:#f9d749;" <?php } ?>  <?php if ($all_data->cancel_policy == 'Strict') { ?>class= 'hidden'<?php } else if (($all_data->cancel_policy == 'Flexible' || $all_data->cancel_policy == 'Moderate')) { ?> data-toggle="modal" data-target="#myModal2ad" <?php } else { ?> class= 'disabled' <?php } ?>>
                                            <a><?php if ($all_data->user_htl_reach_status == 5) { echo  __("Refunded"); }else{ echo  __("Issue A Refund");} ?></a>
                                        </li>
                                    <?php } ?>

                                    <li  <?php if (($all_data->payment_status == 4) || ($all_data->user_htl_reach_status == 2) || ($all_data->user_htl_reach_status == 1) || ($all_data->user_htl_reach_status == 4) ) { ?> class= 'disabled' <?php } ?> <?php if ($all_data->user_htl_reach_status == 3) { ?> style="background:#f9d749;" <?php } ?>><a  <?php if ($all_data->payment_status != 4) { ?> data-toggle="modal" data-target="#myModal1ad" <?php } ?> ><?php if ($all_data->user_htl_reach_status == 3) { echo  __("Cancelled"); }else{ echo  __("Cancel Booking");} ?></a></li>
                                    <li></li>
                                </ul>
                            </div>
                        </div>
