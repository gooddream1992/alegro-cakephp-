                ...
                <div class="head-section">
                        ...
                        <section class="panel">
                            <div class="panel-body">
                                <div>
                                    ...
                                    <div id="cal_sec">
                                        <div  id='calendar1' style="float: left;padding: 27px;" ></div>
                                        <div  id='calendar2' style="float: left;padding: 27px;" ></div>  
                                        <div  id='calendar3' style="float: left;padding: 27px;" ></div>
                                    </div>
                    ...
                    <div class="last-section">
                        ...
                        <ul>
                            ...
                            <li><a href="amenities.html">PREVIOUS</a></li>
                        </ul>
                    </div>
                    <?= $this->Form->end(); ?>
                </div>
