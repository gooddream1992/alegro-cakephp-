...
<section id="search-results-body">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-4 col-lg-3">
                <div class="container filters-list h-auto">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button class="btn btn-default btn-reset"><?php echo __('Reset All') ?></button>
                        </div>
                    </div>
                </div>
            </div>
 ...
 <?php }else{ if (@$result_property_count != 0) { ?>
                    <div class="container bg-gris header-tab tab tab-results-mob" style="margin-top: 0px;">
                        <div class="d-table w-100 tab-title">
                            <div class="d-table-cell">
                                ...
                                <?php }else{ ?>
                                <span id="cnt"><?= @$result_property_count; ?></span> <?php echo __('Results'); } ?>
                            </div>
                    ...
                    <div id="main_search_data">
                        ...
                        $chkpriceAsc = $this->User->chkpriceAsc($result_property);
                        $allpro_id=array();
                        foreach ($chkpriceAsc as $property) {
                        ...
                        foreach ($boostidStatus as $list) {
                            ...
                            <div class="hotel-lsting <?php if($boostStatus ==1 ){ ?>sponsore-list<?php } ?>">
                                <div class="hotel-lsting-left">
                                    <?php if($boostStatus ==1 ){ ?> <span><?php echo __('Sponsored') ?></span> <?php }else { if ($htl_rm_pric_frea > 0) { ?>
                                ...
                                <div class="hotel-lsting-right">
                                    <h6><?php echo $this->User->reviewCount($list->property_id); ?> <?php echo __('reviews') ?><span><?php echo is_nan($this->User->totalRating($list->property_id)) ? 0 : $this->User->totalRating($list->property_id); echo "/5"; ?></span></h6>
                                    ...
                                    <h5><?php if ($htl_rm_pric_frea > 0) { ?>
                                        ...
                                        <h6 style="color:green;font-size: 15px;">
                                            ...
                                            ?>
                                                ...
                                                echo " " . __('for')
                                                ?> <?= $dateDifference; ?> <?php echo __('nights');
                                            } ?>
                                        </h6>
                                        <?php } ?> 
                                        <?php if ($htl_rm_pric_frea > 0) { ?>
                                        ...
                                        <h6 style="color:green;font-size: 15px;">
                                            ...
                                            if ($dateDifference < 2) {
                                                echo " " . __('for')
                                                ?> <?= $dateDifference; ?> <?php echo __('night');
                        } else {
                            echo " " . __('for')
                            ?> <?= $dateDifference; ?> <?php echo __('nights');
                        } ?>
                            ...
                            <?php } ?>
                                    <div class="form-group" style="margin:0; float: right;">
                                        <label>&nbsp;</label>
                                        <a href="<?= HTTP_ROOT; ?>preview/<?= $list->property_id; ?>?<?= $_SERVER['QUERY_STRING']; ?>" target="_blank"><button type="button" class="btn btn-primary hvr-grow btn-fill"><?php echo __('Check Availability') ?></button></a>
                                    </div>
                                </div> 
                            </div>

                    <?php } 
                    $allpropertyresults = $allpro_id;
                    if(!empty($boostidStatus)){
        ...
        $aminity = $this->User->propertyAmenities($allresults->property_id, $guest);
                    ...
                    ?>
                                ...
                                <div class="hotel-lsting-middle" style="width: 48%;">
                                    ...
                                    <p><?= $this->User->propertySize($allresults->property_id, $guest); ?> <?php echo __('Sqm') ?> <br>
                                        <i class="fas fa-users"></i> <?php
                                        //echo $list->id;
                                        ...
                                        ?><br>
                                        <i class="fas fa-map-marker-alt"></i> 
                                            <?php echo $this->User->stateName($allresults->property_id, $guest).','.' '. $this->User->cityName($allresults->property_id, $guest); ?>                                       <br>
                                        <?php
                                        //pj($aminity);
                                        $aminityx = [];
                                        $geta = json_decode($aminity);
                                ...
                                <div class="hotel-lsting-right">
                                    <h6><?php echo $this->User->reviewCount($allresults->property_id); ?> <?php echo __('reviews') ?><span><?php echo is_nan($this->User->totalRating($allresults->property_id)) ? 0 : $this->User->totalRating($allresults->property_id); echo "/5"; ?></span></h6>
                            ...
                            <?php } ?>
                                    <div class="form-group" style="margin:0; float: right;">
                                        <label>&nbsp;</label>
                                        <a href="<?= HTTP_ROOT; ?>preview/<?= $allresults->property_id; ?>?<?= $_SERVER['QUERY_STRING']; ?>" target="_blank"><button type="button" class="btn btn-primary hvr-grow btn-fill"><?php echo __('Check Availability') ?></button></a>
                                    </div>
                                </div> 
                            </div>
    <?php } ?>
...
<?php } ?>
        ...
        jQuery.ajax({
            ...
            dataType: 'html',
            data: {rooms_count: rooms_count, hotel_check_out_date: hotel_check_out_date, hotel_check_in_date: hotel_check_in_date, children: children, adult: adult, start_price: st_pri, end_price: ed_pri, sortby: sortby, star_rating: star_rating, city: "<?= $_GET['from_location_name']; ?>", top_amenities: top_amenities, parking_transportation: parking_transportation, guest_services: guest_services, accessibility: accessibility, facilities: facilities, activities_entertainment: activities_entertainment, food_drink: food_drink, kitchen_dining: kitchen_dining, media_technology: media_technology, meetings_events: meetings_events, essentials: essentials, pools_wellness: pools_wellness, url_query: '<?= $_SERVER['QUERY_STRING']; ?>'},
            success: function (res) {
