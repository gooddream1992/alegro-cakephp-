...
<div class="container">
    <nav class="navbar navbar-expand-lg navbar-light navbar-trans">
        <a class="navbar-brand" href="<?php echo HTTP_ROOT ?>"><img src="<?php echo HTTP_ROOT . 'img/header-logo.png' ?>" width="130"><div style="margin: -12px 0px -10px 104px;font-size: 12px;color: #000;font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif !important;font-weight: bold;">Extranet</div></a>
