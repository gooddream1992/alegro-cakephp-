                                ...
                                <div class="unnamed-property">
                                    ...
                                    <div class="finish-listing">
                                        <?php if ($list->complete_ststus != 1) { ?>
                                            <a style="color:#000; font-size: 15px;" href="" data-toggle="modal" data-target="#myModalfin<?php echo $list->id; ?>" title="<?php echo __('Finish listing'); ?>"><i class="fas fa-redo-alt"></i></a>

                                            <!--Start Finalize Property Modal-->
                                            <div class="modal fade new-message delet-message" id="myModalfin<?php echo $list->id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        ...
                                        <?php } else { ?>
                                            <a style="color:#000; font-size: 15px;" href="" data-toggle="modal" data-target="#myModaledit<?php echo $list->id; ?>" title="<?php echo __('Edit'); ?>"><i class="fas fa-edit"></i></a>




                                            <!--Start Edit Property Modal-->
                                            <div class="modal fade new-message delet-message" id="myModaledit<?php echo $list->id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fas fa-times"></i></button>
                                        ...
                                        <?php } ?>
                                        <a style="font-size: 15px;"class="text-danger" href="" data-toggle="modal" data-target="#myModaldel<?php echo $list->id; ?>" title="<?php echo __('Delete listing'); ?>"><i class="fas fa-trash-alt"></i></a>



                                        <!--Start Delete Property Modal-->
                                        <div class="modal fade new-message delet-message" id="myModaldel<?php echo $list->id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fas fa-times"></i></button>
                                        ...
                                        if ($list->complete_ststus == 1) {
                                            if ($list->active_ststus == 0) {
                                                ?>
                                                <a style="color:#000; font-size: 15px;" href=""  data-toggle="modal" data-target="#myModalact<?php echo $list->id; ?>" title="<?php echo __('Active listing'); ?>"><i class="fas fa-play"></i></a>

                                                <!--Start Activate Property Modal-->
                                                <div class="modal fade new-message delet-message" id="myModalact<?php echo $list->id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fas fa-times"></i></button>
                                            ...
                                            <?php } else {
                                                ?>
                                                <a style="color:#000; font-size: 15px;" href="" data-toggle="modal" data-target="#myModalpause<?php echo $list->id; ?>"

                                                   title="<?php echo __('Deactive listing'); ?>"><i class="fas fa-pause-circle"></i></a>

                                                <!--Start Pause Property Modal-->
                                                <div class="modal fade new-message delet-message" id="myModalpause<?php echo $list->id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fas fa-times"></i></button>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <div id="profile-name">
                    <div class="form-group">
                        <div>
                            <textarea rows="5" name="description" type="text" id="userDescription" class="form-control" style="margin: 0px -3px 0px 0px; width: 1103px; height: 235px;" placeholder="Description"><?= $edit_det->description; ?></textarea>
...
<!--Start Delete Property Modal-->
<div class="modal fade new-message delet-message" id="myModaldel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fas fa-times"></i></button>
...
<!--Start Finalize Property Modal-->
<div class="modal fade new-message delet-message" id="myModalfin" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fas fa-times"></i></button>
                <h4 class="modal-title"><?= __("Finalize Property"); ?></h4>
            </div>
            <div class="modal-body">
                <p><?= __("Are you sure you want to finalize this publishing?"); ?></p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default cancel-m" data-dismiss="modal"><?= __("Ignore"); ?></button>
                <a class="btn btn-primary" href="<?= HTTP_ROOT . 'extranets/basic_tab/' . $list->id; ?>"><?= __("Finalize"); ?></a>
