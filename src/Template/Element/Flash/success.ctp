    ...
    <div id="Message_send_successfully" class="modal fade in" style="display: block;">
        <div class="modal-dialog modal-confirm">
            <div class="modal-content" style="background: #fff;">
                ...
                <div class="modal-body">
                    <p class="text-center"><?php echo __('Your message has been sent. Please wait, as you should get a reply as soon as possible.') ?></p>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-success btn-block" data-dismiss="modal" onclick='getClose("Message_send_successfully")'><?php echo __('OK') ?></button>
                </div>
            </div>
        </div>
    </div>
