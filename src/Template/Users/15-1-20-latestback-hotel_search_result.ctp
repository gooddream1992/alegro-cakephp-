                                    ...
                                    <?php
                                     ...
                                     foreach ($allAminitie as $val) { ?>
                                        ...
                                        if ($key == 'Top Amenities') {
                                            ...
                                            echo in_array($val, $htl_aminity_s_property_type) ? '' : 'disabled';
                                        }elseif ($key == 'Booking type') {
                                            echo in_array($val, $htl_aminity_s_booking_type) ? '' : 'disabled';
                                        }
                                        ?>>
                                            ...
                                            if ($key == 'Top Amenities') {
                                                ...
                                                echo in_array($val, $htl_aminity_s_property_type) ? 'checked' : 'disabled';
                                            }elseif ($key == 'Booking type') {
                                                echo in_array($val, $htl_aminity_s_booking_type) ? 'checked' : 'disabled';
                                            }
                ...
                <?php if (date('Y-m-d') > date("Y-m-d", strtotime(str_replace('/', '-', @$_GET['hotel_check_in'])))) {  ?>
                    ...
                    if (@$result_property_count != 0) {  e
                        ...
                        <div id="main_search_data">
                            ...
                            $guest = $_GET['adult'] + @$_GET['children'];
                            //pj($result_property);exit;
                            $boostidStatus = $this->User->chkBoostDesc($result_property,$guest);
                            //pj($boostStatus);exit;
...
if($bookingtypex == 2){ ?>
                             ...
                             <div class="form-group" style="margin:0; float: right;">
                                            <label>&nbsp;</label>
                                            <a href="<?= HTTP_ROOT; ?>preview_private/<?= $list->property_id; ?>?<?= $_SERVER['QUERY_STRING']; ?>" target="_blank"><button type="button" class="btn btn-primary hvr-grow btn-fill"><?php echo __('Check Availability') ?></button></a>
                                        </div>
                                    <?php } else { ?>

                             <div class="form-group" style="margin:0; float: right;">
                                            <label>&nbsp;</label>
                                            <a href="<?= HTTP_ROOT; ?>preview_entire/<?= $list->property_id; ?>?<?= $_SERVER['QUERY_STRING']; ?>" target="_blank"><button type="button" class="btn btn-primary hvr-grow btn-fill"><?php echo __('Check Availability') ?></button></a>
                                        </div>
...
if($bookingtypex == 2){ ?>
                             ...
                             <div class="form-group" style="margin:0; float: right;">
                                            <label>&nbsp;</label>
                                            <a href="<?= HTTP_ROOT; ?>preview_private/<?= $list1->property_id; ?>?<?= $_SERVER['QUERY_STRING']; ?>" target="_blank"><button type="button" class="btn btn-primary hvr-grow btn-fill"><?php echo __('Check Availability') ?></button></a>
                                        </div>
                                    <?php } else { ?>

                             <div class="form-group" style="margin:0; float: right;">
                                            <label>&nbsp;</label>
                                            <a href="<?= HTTP_ROOT; ?>preview_entire/<?= $list1->property_id; ?>?<?= $_SERVER['QUERY_STRING']; ?>" target="_blank"><button type="button" class="btn btn-primary hvr-grow btn-fill"><?php echo __('Check Availability') ?></button></a>
                                        </div>
