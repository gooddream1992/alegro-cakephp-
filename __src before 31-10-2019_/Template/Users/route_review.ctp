            ...
            <div class="col-sm-4 col-md-5 col-lg-4">
                <div class="row no-gutters destination-search-left-infos">
                    ...
                    <div class="col-9">
                        <div class="row">
                            <div class="col">
                                <div class="destination-search-title"> <?= __($this->User->cityHelper($fligh_det['origin'])->city); ?> - <?= __($this->User->cityHelper($fligh_det['destination'])->city); ?></div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                ...
                <div class=" col-sm-4 col-md-5 col-lg-4  ">
                    <div class="row no-gutters destination-search-left-infos">
                        ...
                        <div class="col-9">
                            <div class="row">
                                <div class="col"> 
                                    <div class="destination-search-title"> <?= __($this->User->cityHelper($fligh_det['destination'])->city); ?> - <?= __($this->User->cityHelper($fligh_det['origin'])->city); ?> </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
            ...
            <div class="col-sm-12 col-md-8 col-lg-8">
                ...
                <div class="container bg-gris header-tab tab tab-results-mob">
                    <div class="d-table w-100 tab-title left-boxed">
                        <div class="d-table-cell" style="margin-left: -17px;"><i class="fas fa-map-marker-alt" style="font-size: 23px;"></i> <?php echo __('Your flight to') ?> <?php echo __($this->User->cityHelper($fligh_det['destination'])->city) ?> <?php echo __('begins here') ?></div>
                    </div>
                    <div class="econo" style="margin: -90px 38px;">
                        <img src="<?= $this->Url->image('icon/5844-200.png'); ?>" style="width:32px;">
                        <h5 style="font-size: 18px;"><?= __($fligh_det['cabin']); ?></h5>
                    </div>
                </div>
                    ...
                    <div class="details desktop">
                        ...
                        <table class="line line-1">
                            <tbody><tr>
                                    ...
                                    <td>
                                        <p class="time"><?= __(date_format($fligh_det->start_depart_time, 'h:i A')); ?><br><span><?= __(date("M", strtotime($this->Time->format($fligh_det->start_depart_time, 'Y-MM-d')))). __(date(" d", strtotime($this->Time->format($fligh_det->start_depart_time, 'Y-MM-d')))).','.' '. __(date("D", strtotime($this->Time->format($fligh_det->start_depart_time, 'Y-MM-d')))); ?></span></p>
                                    ...
                                    <td class="time-desktop-3">
                                        <p class="time time-3"><?= __(date_format($fligh_det->start_arrival_time, 'h:i A')); ?> <br><span><?= __(date("M", strtotime($this->Time->format($fligh_det->start_arrival_time, 'Y-MM-d')))). __(date(" d", strtotime($this->Time->format($fligh_det->start_arrival_time, 'Y-MM-d')))).','.' '. __(date("D", strtotime($this->Time->format($fligh_det->start_arrival_time, 'Y-MM-d')))); ?></span></p>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="time-mobile-3">
                                        <p class="departure"><?= __($this->User->cityHelper($fligh_det['origin'])->city) . ' (' . __($fligh_det['origin']) . ')'; ?></p>
                                    </td>

                                    <td>
                                        <p class="departure"><?= __($this->User->cityHelper($fligh_det['destination'])->city) . ' (' . __($fligh_det['destination']) . ')'; ?></p>
                                    </td>
...
<?php if (!empty($fligh_det->return_d_airline_name)) { ?>
                            ...
                            <table class="line line-2">
                                <tbody><tr>
                                        ...
                                        <td>
                                            <p class="time"><?= __(date_format($fligh_det->return_depart_time, 'h:i A')); ?> <br> <span><?= __(date("M", strtotime($this->Time->format($fligh_det->return_depart_time, 'Y-MM-d')))). __(date(" d", strtotime($this->Time->format($fligh_det->return_depart_time, 'Y-MM-d')))).','.' '. __(date("D", strtotime($this->Time->format($fligh_det->return_depart_time, 'Y-MM-d')))); ?></span></p>
                                        ...
                                        <td class="time-desktop-3">
                                            <p class="time time-3"><?= __(date_format($fligh_det->return_arrival_time, 'h:i A')); ?> <br> <span><?= __(date("M", strtotime($this->Time->format($fligh_det->return_arrival_time, 'Y-MM-d')))). __(date(" d", strtotime($this->Time->format($fligh_det->return_arrival_time, 'Y-MM-d')))).','.' '. __(date("D", strtotime($this->Time->format($fligh_det->return_arrival_time, 'Y-MM-d')))); ?></span></p>
                                        </td>
                        ...
                        <table class="line">
                            <tbody><tr>
                                ...
                                <tr>
                                    ...
                                    <td class="">
                                        <p class="time"><?= __(date_format($fligh_det->start_arrival_time, 'h:i A')); ?> <br> <span><?= __(date("M", strtotime($this->Time->format($fligh_det->start_arrival_time, 'Y-MM-d')))). __(date(" d", strtotime($this->Time->format($fligh_det->start_arrival_time, 'Y-MM-d')))).','.' '. __(date("M d, D", strtotime($this->Time->format($fligh_det->start_arrival_time, 'Y-MM-d')))); ?></span></p>
                                    </td>
...
<?php if (!empty($fligh_det->return_d_airline_name)) { ?>
                            ...
                            <table class="line line-2">
                                <tr>
                                    ...
                                    <td class="">
                                        <p class="time"><?= __(date_format($fligh_det->return_depart_time, 'h:i A')); ?><br><span><?= date("M", strtotime($this->Time->format($fligh_det->return_depart_time, 'Y-MM-d'))). date(" d", strtotime($this->Time->format($fligh_det->return_depart_time, 'Y-MM-d'))).','.' '. date("D", strtotime($this->Time->format($fligh_det->return_depart_time, 'Y-MM-d'))); ?></span></p>
                                    </td>
                                    <td rowspan="2">
                                        <div class="departArrivale">
                                            <span><?= $fligh_det['destination']; ?></span><span><?= $fligh_det['origin']; ?></span>
                                ...
                                <tr>
                                    ...
                                    <td class="">
                                        <p class="time"><?= __(date_format($fligh_det->return_arrival_time, 'h:i A')); ?> <br><span><?= __(date("M", strtotime($this->Time->format($fligh_det->return_arrival_time, 'Y-MM-d')))). __(date(" d", strtotime($this->Time->format($fligh_det->return_arrival_time, 'Y-MM-d')))).','.' '. __(date("D", strtotime($this->Time->format($fligh_det->return_arrival_time, 'Y-MM-d')))); ?></span></p>
                                    </td>
                ...
                <div class="adult">
                    <div class="container bg-gris header-tab tab tab-results-mob">
                        <div class="d-table w-100 tab-title">
                            <div class="d-table-cell" style="margin-left: -17px;"><i class="fas fa-male" style="font-size: 25px;"></i> <?php echo __('Passenger') ?> <?= $contr; ?></div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="<?= $contr - 1; ?>['doctyp']" id="<?= $contr - 1; ?>doctyp" onchange='idPass("<?= $contr - 1; ?>")' required>
                                        ...
                                        <option value="Birth Certificate"><?php echo __('Birth Certificate'); ?></option>
                                    </select>
                                    <i class="fa fa-angle-down formIconArrow"></i>
                                </div>
                            </div>
                    ...
                    <h3 class="title  m-20" style="margin-left: 18px;"><i class="fas fa-suitcase"></i> <?php echo __('Luggage'); ?></h3>
                    <?php
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="email1" name="email" required="required" placeholder="Enter Email Address" value="<?php
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input placeholder="<?php echo __('Enter Email Address'); ?>" type="text" required="required" id="confirmemail" name="confirmemail" class="form-control" value="<?php
                                    if (!empty($this->request->getSession()->read('Auth.User.id'))) {
                                        echo $this->User->usrHelper($this->request->getSession()->read('Auth.User.id'))->email;
                                    }
                                    ?>">
...
<?php } ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="input_reason" class="form-control airlinehide box6" name="location" required="required">
                                            ...
                                            <?php foreach($provincelists as $prov_n){ ?>
                                            <option value="<?php echo $prov_n; ?>" <?php if (!empty($this->request->getSession()->read('Auth.User.id'))) { echo ($this->User->usrdetHelper($this->request->getSession()->read('Auth.User.id'))->province == $prov_n)?'selected':''; } ?>><?php echo __($prov_n); ?></option>
                                            <?php } ?>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input placeholder="Enter Phone Number" required="required" maxlength="10" type="number" name="phonenumber" class="form-control" value="<?php
                                    if (!empty($this->request->getSession()->read('Auth.User.id'))) {
            ...
            <div class="card">
                ...
                <ul class="cardTipe">
                    ...
                    <li><img src="<?= $this->Url->image('paypal.png'); ?>" alt="" style="border-radius: 4px;"></li>
                    <li><img src="<?= $this->Url->image('visa.jpg'); ?>" alt="" style="border-radius: 4px;"></li>
                    <li><img src="<?= $this->Url->image('mastercard.png'); ?>" alt="" style="border-radius: 4px;"></li>
                </ul>
            ...
            <div class="pricebreakdown-2">
                <div class="container bg-gris header-tab tab tab-results-mob">
                    <div class="d-table w-100 tab-title">
                        <div class="d-table-cell" style="
                             width: 645px;
                             "><i class="fas fa-receipt" style="font-size: 22px;"></i> <?php echo __('Your Order'); ?></div>
                ...
                <table style="margin-left: 27px;width: 283px;margin-top: -15px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="width: 680px;border-bottom: 1px solid #eeeeee;text-transform: uppercase;font-weight:bold;padding-bottom: 10px;"><?php echo __('PRICE PER PERSON') ?></td>
                            <td style="width: 401px;border-bottom: 1px solid #eeeeee;text-transform: uppercase;">
                                 <?php
                                $priceperperson = $mainprice;
                        ...
                        <tr>
                            ...
                            <td style="width: 244px;border-bottom: 1px solid #eeeeee;text-transform: uppercase;"><?php
                                if ($this->User->cityHelper($fligh_det['origin'])->country == "Angola" && $this->User->cityHelper($fligh_det['destination'])->country == "Angola") {
                                    $service_fee = $servicefee->domestic * explode(" ", $cabin['passenger'])[0];
                                } else {
                                    $service_fee = $servicefee->international * explode(" ", $cabin['passenger'])[0];
                                }
                        ...
                        <tr>
                            ...
                            <td style="width: 244px;border-bottom: 1px solid #eeeeee;text-transform: uppercase;"> <?php
                                if ($this->User->cityHelper($fligh_det['origin'])->country == "Angola" && $this->User->cityHelper($fligh_det['destination'])->country == "Angola") {
                                    $total_peice = ($servicefee->domestic * explode(" ", $cabin['passenger'])[0]) + ($mainprice * explode(" ", $cabin['passenger'])[0]);
                                } else {
                                    $total_peice = ($servicefee->international * explode(" ", $cabin['passenger'])[0]) + ($mainprice * explode(" ", $cabin['passenger'])[0]);
                                }
                                if (!empty($this->request->session()->read("CURRENCY"))) {
...
<script>
    function idPass(x) {
        ...
        if ($("#" + x + "doctyp option:selected").val() == "Birth Certificate") {
            $("#" + x + "passIssediv").hide();
            $("#" + x + "passnumdiv").hide();
            $("#" + x + "passexpdiv").hide();
            $("#" + x + "passIsselable").html("<?= __('Birth Certificate Issue Country'); ?>");
            $("#" + x + "passnumlab").html("<?= __('Assento Number'); ?>");
            $("#" + x + "passexplable").html("<?= __('Process Number'); ?>");
            $("#" + x + "passIssediv").show();
            $("#" + x + "passnumdiv").show();
            $("#" + x + "passexpdiv").show();
        }
