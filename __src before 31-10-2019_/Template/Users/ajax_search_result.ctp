...
<div class="se-pre-con"> 
    ...
    <div class="top-last" style="color: #000;text-align:  center; font-weight: bold;">
        <span style="font-size: 2em; color:#000;">
                    <?= __(date("D", strtotime(str_replace('/', '-', $_GET['departure_date'])))). __(date(", d ", strtotime(str_replace('/', '-', $_GET['departure_date'])))).__(date("M", strtotime(str_replace('/', '-', $_GET['departure_date'])))); ?> 
                        <?php if ($_GET['radio'] != "One-Way Flight") { ?>- 
                            <?= __(date("D", strtotime(str_replace('/', '-', $_GET['return_date'])))). __(date(", d ", strtotime(str_replace('/', '-', $_GET['return_date'])))). __(date("M", strtotime(str_replace('/', '-', $_GET['return_date'])))); ?>
                                <?php } ?></span>  <br>
        <span style="font-size: 20px; color:#000;"><?php 
            ...
            <div class="col-sm-4 col-md-5 col-lg-4">
                <div class="row no-gutters destination-search-left-infos">
                    ...
                    <div class="col-9">
                        <div class="row">
                            <div class="col">
                                <div class="destination-search-title"> <?= __($this->User->cityHelper($_GET['origin'])->city); ?> - <?= __($this->User->cityHelper($_GET['destination'])->city); ?></div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="destination-search-subtitle"> <?= __(date("M", strtotime(str_replace('/', '-', $_GET['departure_date'])))). __(date(" d", strtotime(str_replace('/', '-', $_GET['departure_date'])))).','.' '. __(date("D", strtotime(str_replace('/', '-', $_GET['departure_date'])))); ?> -
                                    <?php
                                    if (isset($_GET['passenger'])) {
                                        $psn = explode(" ", $_GET['passenger'])[0];
                                        if ($psn > 1) {
                ...
                <div class=" col-sm-4 col-md-5 col-lg-4  ">
                    <div class="row no-gutters destination-search-left-infos">
                        ...
                        <div class="col-9">
                            <div class="row">
                                <div class="col">
                                    <div class="destination-search-title"> <?= __($this->User->cityHelper($_GET['destination'])->city); ?> - <?= __($this->User->cityHelper($_GET['origin'])->city); ?> </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="destination-search-subtitle"> <?= __(date("M", strtotime(str_replace('/', '-', $_GET['return_date'])))). __(date(" d", strtotime(str_replace('/', '-', $_GET['return_date'])))).','.' '. __(date("D", strtotime(str_replace('/', '-', $_GET['return_date'])))); ?> - <?php
                                        if (isset($_GET['passenger'])) {
                                            $psn = explode(" ", $_GET['passenger'])[0];
                                            if ($psn > 1) {
                                                echo $psn. ' ' . __('Passengers');
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group" style="margin-bottom: 0px;">
                                            ...
                                            <div class="form-control passenger-selector-toggle psngrsHow box5" data-id="1" style="margin-bottom: 0px;"><?php
                                                if (isset($_GET['passenger'])) {
                                                    $passngr = explode(" ", $_GET['passenger'])[0];
                                                    if ($passngr > 1) {
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="collapseElem collapse show" id="collapseElem-4">
                                <label class="container-radio checkbox">
                                    <input type="checkbox" class="air_ports"  name="orgi" checked> <span class="checkmark"></span> <span class="labelT"><?= __($this->User->cityHelper($_GET['origin'])->data); ?></span> </label>
                                <label class="container-radio checkbox">
                                    <input type="checkbox" class="air_ports" name="desi" checked> <span class="checkmark"></span> <span class="labelT"> <?= __($this->User->cityHelper($_GET['destination'])->data); ?></span> </label>
                    ...
                    <div class="d-table w-100 tab-title">
                        ...
                        <div class="d-table-cell">
                            <select name="" id="sortBy" class="sortBy">
                                ...
                                <option value="refundable.DESC"><?php echo __('Refundable') ?></option>
                                <option value="refundable.ASC"><?php echo __('Non-refundable') ?></option>
                            </select>
                        ...
                        foreach ($search_det_dats as $resut) {
                            ...
                            <div class="searchItem d-flex">
                                    ...
                                    <table class="line line-1">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <p class="time"><?= __(date_format($resut->start_depart_time, 'h:i A')); ?><br><span>
                                                <?= __(date("M", strtotime($this->Time->format($resut->start_depart_time, 'Y-MM-d')))). __(date(" d", strtotime($this->Time->format($resut->start_depart_time, 'Y-MM-d')))).','.' '. __(date("D", strtotime($this->Time->format($resut->start_depart_time, 'Y-MM-d')))); ?></span></p>
                                            ...
                                            <td class="time-desktop-3">
                                                <p class="time time-3"><?= __(date_format($resut['start_arrival_time'], 'h:i A')); ?> <br><span><?= __(date("M", strtotime($this->Time->format($resut['start_arrival_time'], 'Y-MM-d')))). __(date(" d", strtotime($this->Time->format($resut['start_arrival_time'], 'Y-MM-d')))).','.' '. __(date("D", strtotime($this->Time->format($resut['start_arrival_time'], 'Y-MM-d')))); ?></span></p>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="time-mobile-3">
                                                <p class="departure"><?= __($this->User->cityHelper($_GET['origin'])->city) . ' (' . __($_GET['origin']) . ')'; ?></p>
                                            </td>

                                            <td>
                                                <p class="Arrival"><?= __($this->User->cityHelper($_GET['destination'])->city) . ' (' . __($_GET['destination']) . ')'; ?></p>
                                            </td>
                                    ...
                                    <?php if ($fli['jor_typ'] == "Journey Details Return") { ?>
                                        ...
                                        <table class="line line-2">
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="time"><?= __(date_format($resut['return_depart_time'], 'h:i A')); ?> <br><span><?= __(date("M", strtotime($this->Time->format($resut['return_depart_time'], 'Y-MM-d')))). __(date(" d", strtotime($this->Time->format($resut['return_depart_time'], 'Y-MM-d')))).','.' '. __(date("D", strtotime($this->Time->format($resut['return_depart_time'], 'Y-MM-d')))); ?></span></p>
                                                ...
                                                <td class="time-desktop-4">
                                                    <p class="time time-4"><?= __(date_format($resut['return_arrival_time'], 'h:i A')); ?> <br><span><?= __(date("M", strtotime($this->Time->format($resut['return_arrival_time'], 'Y-MM-d')))). __(date(" d", strtotime($this->Time->format($resut['return_arrival_time'], 'Y-MM-d')))).','.' '. __(date("D", strtotime($this->Time->format($resut['return_arrival_time'], 'Y-MM-d')))); ?></span></p>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="time-mobile-4">
                                                    <p class="departure"><?= __($this->User->cityHelper($_GET['destination'])->city) . ' (' . __($_GET['destination']) . ')'; ?></p>
                                                </td>

                                                <td>
                                                    <p class="Arrival"><?= __($this->User->cityHelper($_GET['origin'])->city) . ' (' . __($_GET['origin']) . ')'; ?></p>
                                                </td>
                                ...
                                <div class="details mobile">
                                    <table class="line">
                                        <tr>
                                            ...
                                            <td class="">
                                                <p class="time"><?= __(date_format($resut['start_depart_time'], 'h:i A')); ?><br><span><?= __(date("M", strtotime($this->Time->format($resut['start_depart_time'], 'Y-MM-d')))). __(date(" d", strtotime($this->Time->format($resut['start_depart_time'], 'Y-MM-d')))).','.' '. __(date("D", strtotime($this->Time->format($resut['start_depart_time'], 'Y-MM-d')))); ?></span></p>
                                            </td>
                                            <td rowspan="2">
                                                <div class="departArrivale">
                                        ...
                                        <tr>
                                            ...
                                            <td class="">
                                                <p class="time"><?= __(date_format($resut['start_arrival_time'], 'h:i A')); ?> <br><span><?= __(date("M", strtotime($this->Time->format($resut['start_arrival_time'], 'Y-MM-d')))). __(date(" d", strtotime($this->Time->format($resut['start_arrival_time'], 'Y-MM-d')))).','.' '. __(date("D", strtotime($this->Time->format($resut['start_arrival_time'], 'Y-MM-d')))); ?></span></p>
                                            </td>
                                    ...
                                    <?php if ($fli['jor_typ'] == "Journey Details Return") { ?>
                                        ...
                                        <table class="line line-2">
                                            ...
                                            <tr>
                                                ...
                                                <td class="">
                                                    <p class="time"><?= __(date_format($resut['return_arrival_time'], 'h:i A')); ?> <br><span><?= __(date("M", strtotime($this->Time->format($resut['return_arrival_time'], 'Y-MM-d')))). __(date(" d", strtotime($this->Time->format($resut['return_arrival_time'], 'Y-MM-d')))).','.' '. __(date("D", strtotime($this->Time->format($resut['return_arrival_time'], 'Y-MM-d')))); ?></span></p>
                                                </td>
                                ...
                                <div class="bookBtn text-center">
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#flightDetailsModal<?= $resut->id; ?>" class="btn-book" style="margin: 15px 0px 0px 0px;"><?php echo __('Book') ?></a>
                                </div>
                            </div>
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="row">
                                                <div class="col text-left">
                                                    <div class="flight-details-departure-title"> <?php echo __('DEPARTURE') ?>: <?= __($this->User->cityHelper($_GET['origin'])->city); ?> - <?= __($this->User->cityHelper($_GET['destination'])->city); ?> </div>
                                                </div>
                                            </div>
                                            <!-- Flight details row -->
                                            <?php
                                                ...
                                                <div class="row flight-details-row">
                                                    ...
                                                    <div class="col-md-3 col-4 flight-details-infos text-left">
                                                        ...
                                                        <div class="row flight-details-date">
                                                            <div class="col"> <?= __(date("M", strtotime($this->Time->format($fli_de['dep_time'], 'Y-MM-d')))). __(date(" d", strtotime($this->Time->format($fli_de['dep_time'], 'Y-MM-d')))).','.' '. __(date("D", strtotime($this->Time->format($fli_de['dep_time'], 'Y-MM-d')))); ?>, <?= __(date_format($fli_de['dep_time'], 'h:i A')); ?> </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col"> <?= __($this->User->cityHelper($fli_de['origin'])->city); ?> (<?= __($fli_de['origin']); ?>), <?= __($this->User->cityHelper($fli_de['origin'])->country); ?> </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 col-4 flight-details-duration text-center">
                                                        ...
                                                        <div class="row">
                                                            <div class="col"> <?php echo __($_GET['cabin']. ' '. 'Class') ;  ?> </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 col-4 flight-details-infos text-right">
                                                        ...
                                                        <div class="row flight-details-date">
                                                            <div class="col"> <?= __(date("M", strtotime($this->Time->format($fli_de['arr_time'], 'Y-MM-d')))). __(date(" d", strtotime($this->Time->format($fli_de['arr_time'], 'Y-MM-d')))).','.' '. __(date("D", strtotime($this->Time->format($fli_de['arr_time'], 'Y-MM-d')))); ?>, <?= __(date_format($fli_de['arr_time'], 'h:i A')); ?> </div>
                                                        </div>
                                                        <div class="row">
                                            ...
                                            <?php if ($fli['jor_typ'] == "Journey Details Return") { ?>
                                                <div class="row">
                                                    <div class="col text-left">
                                                        <div class="flight-details-departure-title"> <?php echo __('RETURN') ?>: <?= __($this->User->cityHelper($_GET['destination'])->city); ?> - <?= __($this->User->cityHelper($_GET['origin'])->city); ?> </div>
                                                    </div>
                                                </div>
                                                <!-- Flight details row -->                  
                                            <?php } ?>
                                            ...
                                            for ($ini = $jor_st_cn + 1; $ini <= $po_end + 1; $ini++) {
                                                ...
                                                <div class="row flight-details-row">
                                                    ...
                                                    <div class="col-md-3 col-4 flight-details-infos text-left">
                                                        ...
                                                        <div class="row flight-details-date">
                                                            <div class="col">  <?= __(date("M", strtotime($this->Time->format($fli_re['dep_time'], 'Y-MM-d')))). __(date(" d", strtotime($this->Time->format($fli_re['dep_time'], 'Y-MM-d')))).','.' '. __(date("D", strtotime($this->Time->format($fli_re['dep_time'], 'Y-MM-d')))); ?>, <?= __(date_format($fli_re['dep_time'], 'h:i A')); ?> </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col"> <?= __($this->User->cityHelper($fli_re['origin'])->city); ?> (<?= __($fli_re['origin']); ?>), <?= __($this->User->cityHelper($fli_re['origin'])->country); ?>  </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 col-4 flight-details-duration text-center">
                                                        <div class="row">
                                                    ...
                                                    <div class="col-md-3 col-4 flight-details-infos text-right">
                                                        ...
                                                        <div class="row flight-details-date">
                                                            <div class="col"> <?= __(date("M", strtotime($this->Time->format($fli_re['arr_time'], 'Y-MM-d')))). __(date(" d", strtotime($this->Time->format($fli_re['arr_time'], 'Y-MM-d')))).','.' '. __(date("D", strtotime($this->Time->format($fli_re['arr_time'], 'Y-MM-d')))); ?>, <?= __(date_format($fli_re['arr_time'], 'h:i A')); ?> </div>
                                                        </div>
                                                        <div class="row">
...
<script>
    ...
    var stpr = 0;
    var enpr =<?php echo $this->User->priceConvert($this->request->session()->read("CURRENCY"),$top_price->comp_price + 1); ?>;

    noUiSlider.create(handlesSlider, {
        start: [0, <?= $this->User->priceConvert($this->request->session()->read("CURRENCY"),($top_price->comp_price + 1)); ?>],
        step: 10,
        tooltips: false,
        connect: [false, true, false],
        range: {
            'min': [0],
            'max': [<?= $this->User->priceConvert($this->request->session()->read("CURRENCY"),($top_price->comp_price + 1)); ?>]
        },
        format: wNumb({
            decimals: 0,
            suffix: ' $',
