...
<section class="alavalde-pannel">
    ...
    <!--                    <a href="<?= HTTP_ROOT; ?>booking_private/<?= $result_property->id; ?>?<?= $_SERVER['QUERY_STRING']; ?>">-->
                        <!-- #available-main-->
                                                ...
                                                if ($bookingtypex == 2) {
                                                    ...
                                                    if (($property_availablity == "Booing_Available") && ($property_availablity_date == "Booing_Available")) {
                                                            ...
                                                            <p class="text text-success" style="font-weight: normal;font-size: 15px;">
                                                                <?php if ($htl_rm_pric_frea > 0) { ?>
                                                                    ...
                                                                    if ($dateDifference >= $longDays && !empty($longDays)) {
                                                                        ...
                                                                        if (!empty($this->request->session()->read("CURRENCY"))) {
                                                                            echo $this->request->session()->read("CURRENCY") . ' ' . number_format($this->User->priceConvert($this->request->session()->read("CURRENCY"), $cal002 * $searched_rooms), 2);
                                                                        ...
                                                                        if (!empty($this->request->session()->read("CURRENCY"))) {
                                                                            echo $this->request->session()->read("CURRENCY") . ' ' . number_format($this->User->priceConvert($this->request->session()->read("CURRENCY"), $cal003 * $searched_rooms), 2);
                                                                            ?> <?= ' ' . __("for"); ?> <?= $dateDifference; ?><?php
                                                                        } else {
                                                                ...
                                                                <?php } else { ?>
                                                                    ...
                                                                    if ($dateDifference >= $longDays && !empty($longDays)) {
                                                                        ...
                                                                        if (!empty($this->request->session()->read("CURRENCY"))) {
                                                                            echo $this->request->session()->read("CURRENCY") . ' ' . number_format($this->User->priceConvert($this->request->session()->read("CURRENCY"), $cal004 * $searched_rooms), 2);
                                                                            ?><?= ' ' . __("for"); ?> <?= $dateDifference; ?><?php
                                                                        } else {
                                                                        ...
                                                                        if (!empty($this->request->session()->read("CURRENCY"))) {
                                                                            echo $this->request->session()->read("CURRENCY") . ' ' . number_format($this->User->priceConvert($this->request->session()->read("CURRENCY"), $cal005 * $searched_rooms), 2);
                                                                            ?> <?= ' ' . __("for"); ?> <?= $dateDifference; ?> <?php
                                                                        } else {
                                                        ...
                                                        <div class="non-refund-right"  style="float:right">
                                                            <a href="<?= HTTP_ROOT; ?>booking_private/<?= $htl_rm->id; ?>?<?= $_SERVER['QUERY_STRING']; ?>" target="_blank"><?php echo __('Book') ?></a>
                                                        </div>
                                                    <?php } else { ?>
                        ...
                        <div class="Similar-right-box">
                            <div class="Hotel-Alvalade">
                                ...
                                <div class="sc-bdVaJa fJntgG">
                                    <button class="sc-kkGfuU fxNDjV sc-iwsKbI jHpzKw" id="compare-tray-choose-room-button" data-autobot-element-id="HTL_DETAIL_SIMILAR_HOTEL_CHOOSE"><?= __("Choose Roomed"); ?></button>
                                </div>
                            </div>
                            <?php
                            if (!empty($iOne)) {
                                ...
                                foreach ($iOne as $relatedOne) {
                                    if ($rel_pro_count <= $rel_pro_count_max) {
                                        ...
                                        <div class="Hotel-Trópico">
                                            ...
                                            <div class="sc-bdVaJa fJntgG"><a href="<?= HTTP_ROOT; ?>users/preview_private/<?= $relatedOne; ?>?<?= $_SERVER['QUERY_STRING']; ?>"><button class="sc-cNQqM eKqHMe sc-iwsKbI jHpzKw" data-autobot-element-id="HTL_DETAIL_SIMILAR_HOTEL_SELECT"><?php echo __('Select') ?></button></a></div>
                                        </div>
                                        <?php
                                        $rel_pro_count++;
                                    }
