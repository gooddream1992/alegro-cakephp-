            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 modal-left">
                        ...
                        <?= $this->Form->input('email', ['type' => 'email', 'class' => 'form-control', 'id' => 'email', 'placeholder' =>  __('Email Address'), 'label' =>  __('Email Address'), 'required']); ?>


                        <?= $this->Form->input('password', ['type' => 'password', 'class' => 'form-control', 'id' => 'password', 'placeholder' => __("Password"), 'label' => __("Password"), 'required']); ?>
                        ...
                        <div class="social-sign-in">
                            <ul class="list-inline color-white">
                                <li class="list-inline-item">
                                    <a href="<?=HTTP_ROOT;?>users/fblogin">
                                ...
                                <li class="list-inline-item">
                                    <a href="<?=HTTP_ROOT;?>users/googlelogin">
