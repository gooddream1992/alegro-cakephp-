...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <?php if (($userType == 3) || ($userType == 5) || ($userType == 6)) { ?>
                <li class="treeview">
                    <a href="<?php echo HTTP_ROOT . 'appadmins/' ?>guests_refunds">
                        <i class="fa fa-money"></i> <span>Guest Refund</span>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                </li>
            <?php } ?>
            ...
            <?php if (($userType == 3) || ($userType == 5) || ($userType == 6)) { ?>
                <li class="treeview">
                    <a href="<?php echo HTTP_ROOT . 'appadmins/' ?>properties_payments">
                        <i class="fa fa-money"></i> <span>Property Payment</span>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                </li>
            <?php } ?>
            ...
            <?php if (($userType == 3) || ($userType == 5) || ($userType == 6)) { ?>
                <li class="treeview">
                    <a href="<?php echo HTTP_ROOT . 'appadmins/' ?>request_alegro_comission">
                        <i class="fa fa-money"></i> <span>Request Comission</span>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                </li>
            <?php } ?>
