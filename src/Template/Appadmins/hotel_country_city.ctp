                        ...
                        <form method="post" action="<?= $this->Url->build(["controller" => "Appadmins", "action" => "hotel_country_city", $locations_id]); ?>">
                            <div class="row">
                                <div class="col-sm-4 dropdown1" id='dropdown1'>
                                    <label >Country</label>
                                    <input type="text" class="form-control country_name" autocomplete="off" name="country_name" value="<?= @$editData->country_name; ?>" required onclick="$('#dropdown1').addClass('dropdown1');">
                                ...
                                <div class="col-sm-4 dropdown" id='dropdown'>
                                    <label >Province</label>
                                     <input type="text" class="form-control state_name" autocomplete="off" name="state_name"  value="<?= @$editData->state_name; ?>" onclick="$('#dropdown').addClass('dropdown');" >
                                ...
                                <div class="col-sm-4 dropdown2" id='dropdown2'>
                                    ...
                                    <input type="text" class="form-control city_name"  autocomplete="off" name="city_name" value="<?= @$editData->city_name; ?>"  onclick="$('#dropdown2').addClass('dropdown2');">
