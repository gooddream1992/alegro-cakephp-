...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <?php if ($userType == 1) { ?>
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="<?php echo HTTP_ROOT . 'appadmins/view_admin' ?>"><i class="fa fa-circle-o"></i> View all employees</a></li>

                                <!--                            <li><a href="<?php echo HTTP_ROOT . 'appadmins/create_operator' ?>"><i class="fa fa-circle-o"></i> Create Operator</a></li>-->
                        <li><a href="<?php echo HTTP_ROOT . 'appadmins/view_operator' ?>"><i class="fa fa-circle-o"></i> View all Operators</a></li>


                                <!--                            <li><a href="<?php echo HTTP_ROOT . 'appadmins/create_helpdisk' ?>"><i class="fa fa-circle-o"></i> Create Helpdesk</a></li>-->
            ...
            <?php } ?>
            <?php if (($userType == 1) || ($userType == 5) || ($userType == 6)) { ?>
                <li class="treeview">
                    <a href="#">
            ...
            <?php if (($userType == 1)) { ?>
                ...
                <li>
                    <a href="<?php echo HTTP_ROOT . 'appadmins/' ?>hotel_country_city">
                        <i class="fa fa-map-marker"></i> <span>Manage Location for Hotel</span>
                    </a>
                </li>
            ...
            <?php if (($userType == 1) || ($userType == 5)) { ?>
                <li>
                    <a href="<?php echo HTTP_ROOT . 'appadmins/' ?>registered_property">
                        <i class="fa fa-building"></i> <span>Manage Property</span>
                    </a>
                </li>
            ...
            <?php if (($userType == 1) || ($userType == 5) || ($userType == 6)) { ?>
                <li>
                    <a href="<?php echo HTTP_ROOT . 'appadmins/' ?>manage_hotel_booking">
                        <i class="fa fa-book"></i> <span>Manage Property Booking</span>
                    </a>
                </li>
            <?php } ?>
        </ul>
