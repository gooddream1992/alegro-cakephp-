 ...
 */
	public function validate_ipn() {
		...
		// Invalid IPN transaction.  Check the $ipn_status and log for details.
               // mail('sradhak15@gmail.com', 'hii', 'Checking IPN VALIDATION'.$this->ipn_response, "From: info@videoportal.com");
		if (preg_match("/VERIFIED/",$this->ipn_response)) {
                    // mail('sradhak15@gmail.com', 'hii', 'IPN VERIFIED', "From: info@videoportal.com");
			$this->ipn_status = "IPN VERIFIED";
			$this->log_ipn_results(true); 
			return true;
          	} else {
                    
                   //  mail('sradhak15@gmail.com', 'hii', 'IPN Validation Failed', "From: info@videoportal.com");
