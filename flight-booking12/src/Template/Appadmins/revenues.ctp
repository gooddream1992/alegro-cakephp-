...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">All Revenues</li>
        </ol>
    </section>
                    ...
                    <div class="box-body">
                        <div>
                            ...
                            <ul class="vbul">
                                ...
                                <li><input name="year_d" type="text" id="datepicker1" autocomplete="off" ></li>
                                <li>
                        ...
                        <div>
                            ...
                            <ul class="vbul">
                                ...
                                <li><input type="text" name="month_d" id="datepicker2" autocomplete="off" ></li>
                                <li>
                        ...
                        <div>
                            ...
                            <ul class="vbul">
                                ...
                                <li><input type="text" name="week_d1" class="datepicker3" autocomplete="off" ></li>
                                <li><input type="text" name="week_d2" class="datepicker3" autocomplete="off" ></li>
                                <li>
                        ...
                        <div>
                            ...
                            <ul class="vbul">
                                ...
                                <li><input type="text" name="daily_d" class="datepicker3" autocomplete="off" ></li>
                                <li>
