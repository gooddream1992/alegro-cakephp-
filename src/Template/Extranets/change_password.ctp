        ...
        <div class="">
            <div class="">
                <div class="right_histry_head m_btm_20">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="active"><?php echo __('Change Password'); ?></h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg_white right_pro">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><?php echo __('Confirm New Password'); ?><span>*</span></label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <?php echo $this->Form->submit(__('Change'), ['type' => 'submit', 'class' => "btn btn-primary btn-change hvr-grow"]) ?>
                                <!--<input type="submit" class="btn btn-primary btn-change hvr-grow" name="" value="<?php echo __('Change'); ?>">-->
                            </div>
                        </div>
                    </div>
