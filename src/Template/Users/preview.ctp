...
<section class="alavalde-pannel">
    ...
    <!--                    <a href="<?= HTTP_ROOT; ?>booking/<?= $result_property->id; ?>?<?= $_SERVER['QUERY_STRING']; ?>">-->
        <!-- #available-main-->
                        <a href="<?= HTTP_ROOT; ?>booking/<?= $result_property->id; ?>">
...
if($bookingtypex == 2){
                                                ...
                                                if (($property_availablity == "Booing_Available") && ($property_availablity_date == "Booing_Available") ) {
                                                    ...
                                                    <div class="non-refund-right"  style="float:right">
                                                        <a href="<?= HTTP_ROOT; ?>booking/<?= $htl_rm->id; ?>?<?= $_SERVER['QUERY_STRING']; ?>" target="_blank"><?php echo __('Book') ?></a>
                                                    </div>
                                                <?php } else { ?>
                                ...
                                foreach ($iOne as $relatedOne) {
                                    if ($rel_pro_count <= $rel_pro_count_max) {
                                        ...
                                        <div class="Hotel-Trópico">
                                            ...
                                            <div class="sc-bdVaJa fJntgG"><a href="<?= HTTP_ROOT; ?>users/preview/<?= $relatedOne; ?>?<?= $_SERVER['QUERY_STRING']; ?>"><button class="sc-cNQqM eKqHMe sc-iwsKbI jHpzKw" data-autobot-element-id="HTL_DETAIL_SIMILAR_HOTEL_SELECT"><?php echo __('Select') ?></button></a></div>
                                        </div>
                                        <?php
                                        $rel_pro_count++;
                                    }
