...
<!--                        <div class="col-md-12" id="select_host" style="display: none;">
                            <label>Select Host</label>
                            <div id="example" >
                                <div class="demo-section k-content">
                                    <select id="select-to-host" class="contacts" name="hosts[]" ></select>
                                </div>
                            </div>
                        </div>-->
...
<script>
    ...
    $('#select-to-host').selectize({
        ...
        options: <?php echo $successHostDetails;?>,
        render: {
            item: function (item, escape) {
                var name = formatName(item);
                return '<div>' +
