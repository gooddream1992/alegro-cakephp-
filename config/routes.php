...
Router::scope('/', function (RouteBuilder $routes) {
    ...
    $routes->connect('/preview_entire/*', ['controller' => 'users', 'action' => 'previewEntire']);
    $routes->connect('/preview_private/*', ['controller' => 'users', 'action' => 'previewPrivate']);
    $routes->connect('/thank_you_private_order/*', ['controller' => 'users', 'action' => 'thankYouPrivateOrder']);
    $routes->connect('/thank_you_entire_order/*', ['controller' => 'users', 'action' => 'thankYouEntireOrder']);
    $routes->connect('/thank_you_at_private_order/*', ['controller' => 'users', 'action' => 'thankYouAtPrivateOrder']);
    $routes->connect('/thank_you_at_entire_order/*', ['controller' => 'users', 'action' => 'thankYouAtEntireOrder']);
	...
	$routes->connect('/published-properties/*', ['controller' => 'pages', 'action' => 'PublishedProperties']);
    ...
    $routes->connect('/booking_private/*', ['controller' => 'users', 'action' => 'bookingPrivate']);
    $routes->connect('/booking_entire/*', ['controller' => 'users', 'action' => 'bookingEntire']);
