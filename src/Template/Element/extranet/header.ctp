            ...
            <div class="row">
                <div class="col-md-6 modal-left">
                    ...
                    <div class="modal-subtitle text-center">
                        <?php echo __('Log in with your Alegro account credentials'); ?>
                    </div>
                    ...
                    <?= $this->Form->input('email', ['type' => 'email', 'class' => 'form-control', 'id' => 'email', 'placeholder' => 'Email Address', 'label' => __('Email Address'), 'required']); ?>


                    <?= $this->Form->input('password', ['type' => 'password', 'class' => 'form-control', 'id' => 'password', 'placeholder' => 'Password', 'label' => __("Password"), 'required']); ?>
                    ...
                    <div class="social-sign-in">
                        <ul class="list-inline color-white">
                            <li class="list-inline-item">
                                <a href="<?=HTTP_ROOT;?>extranets/fblogin">
                            ...
                            <li class="list-inline-item">
                                <a href="<?=HTTP_ROOT;?>extranets/googlelogin">
...
<div id="all_modssss">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-row justify-content-center">
                                <div class="col-md-6 register-button">
                                    <button type="submit" class="btn btn-primary hvr-glow" style="margin: 146px 0px 0px -127px;"><?php echo __('register button'); ?></button>
                                </div>
                            </div>
                            <?php echo $this->Form->end(); ?>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            ...
                            <div class="form-row">
                                ...
                                <div id="msg-error" style="font-size: 15px;margin: 0px 0px -21px 126px;color:red;text-align: center;width: 100%;"></div>
    ...
    <div id="accnt_not" class="modal fade">
        <div class="modal-dialog modal-confirm">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="icon-box">
...
<script>
    function forgetpassword()
    {
        ...
        if (email == "") {
            $('#msg-error').html("<?php echo __('Enter Email Address'); ?>");
