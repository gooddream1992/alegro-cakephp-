                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" required="required" name="dob" class="form-control datepicker-here box3" id="dob" placeholder="Enter Birth Date" value="<?php echo date('Y-m-d', strtotime($userDetails->user_detail->dateofbirth)); ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
