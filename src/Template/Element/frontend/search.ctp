...
<script>
    ...
    function checkWithCheckindate() {
        if ($('#hotel_check_in').val() != "" && $('#hotel_check_out').val() != "") {
            ...
            console.log((($('#hotel_check_out').val().split('/')).reverse()).join());
            if (new Date(((($('#hotel_check_out').val().split('/')).reverse()).join())) > (new Date(((($('#hotel_check_in').val().split('/')).reverse()).join())))) {
...
<div class="formHomeSearch" >
    ...
    <ul class="nav nav-tabs" id='navtabprofile'>
        <li class="hometab active" role='presentation'><a data-toggle="tab" role='tab' href="#menu1"><i class="fa fa-building"></i> <?php echo __('Accommodations') ?> </a></li>
        <!-- <li class="hometab " role='presentation'><a data-toggle="tab" role='tab' href="#home"><i class="fa fa-plane"></i> <?php echo __('Flights') ?> <span style="background-color: red;color: #fff;padding: 4px;margin: 12px;border-radius: 4px;"><?php echo __('Soon') ?></span></a></li>
        <li class="hometab " role='presentation'><a data-toggle="tab" role='tab' href="#menu2"><i class="fa fa-plane"></i> <?php echo __('Flight') ?> + <i class="fa fa-building"></i> <?php echo __('Accommodation') ?> <span style="background-color: red;color: #fff;padding: 4px;margin: 12px;border-radius: 4px;"><?php echo __('Soon') ?></span></a></li> -->
                    ...
                    <div class="col-md-12 no-padding">
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select id="cabin" name="rooms" class="form-control airlinehide box6" required>
                                        ...
                                        <option value="5"><?php echo __('5'); ?></option>
                                        <option value="6"><?php echo __('6'); ?></option>
                                        <option value="7"><?php echo __('7') ?></option>
                                        <option value="8"><?php echo __('8'); ?></option>
                                        <option value="9"><?php echo __('9'); ?></option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>&nbsp;</label>
                                    <button type="submit" id="submit" class="btn btn-primary hvr-grow btn-fill"><?php echo __('Search'); ?></button>
                                    </a>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group dsf" style="margin-bottom: 0px;">
                                        <div style="float: left;">
                                            ...
                                            <select style="display: none;">
                                                ...
                                                <option value="rooms">5</option>
                                                <option value="rooms">6</option>
                                                <option value="rooms">7</option>
                                                <option value="rooms">8</option>
                                                <option value="rooms">9</option>
                                                <option value="rooms">10</option>
                                            </select><div class="nice-select open" tabindex="0"><span class="current">1</span><ul class="list"><li data-value="rooms" class="option selected focus">1</li><li data-value="rooms" class="option">2</li><li data-value="rooms" class="option">3</li><li data-value="rooms" class="option">4</li><li data-value="rooms" class="option">5</li><li data-value="rooms" class="option">6</li><li data-value="rooms" class="option">7</li><li data-value="rooms" class="option">8</li><li data-value="rooms" class="option">9</li><li data-value="rooms" class="option">10</li></ul></div>               
                                        </div>
                                    </div>
                                    <div class="form-group dsf" style="margin-bottom: 0px;">
                                        <div style="float: left">
                                            ...
                                            <select style="display: none;">
                                                ...
                                                <option value="adults">7</option>
                                                <option value="adults">8</option>
                                                <option value="adults">9</option>
                                                <option value="adults">10</option>
                                            </select><div class="nice-select" tabindex="0"><span class="current">1</span><ul class="list"><li data-value="adults" class="option selected focus">1</li><li data-value="adults" class="option">2</li><li data-value="adults" class="option">3</li><li data-value="adults" class="option">4</li><li data-value="adults" class="option">5</li><li data-value="adults" class="option">6</li><li data-value="adults" class="option">7</li><li data-value="adults" class="option">8</li><li data-value="adults" class="option">9</li><li data-value="adults" class="option">10</li></ul></div>               
                                        </div>
                                    </div>
                                    <div class="form-group dsf" style="margin-bottom: 0px;">
                                        <div style="float: left">
                                            ...
                                            <select style="display: none;">
                                                ...
                                                <option value="children">7</option>
                                                <option value="children">8</option>
                                                <option value="children">9</option>
                                                <option value="children">10</option>
                                            </select><div class="nice-select" tabindex="0"><span class="current">0</span><ul class="list"><li data-value="children" class="option selected focus">0</li><li data-value="children" class="option">1</li><li data-value="children" class="option">2</li><li data-value="children" class="option">3</li><li data-value="children" class="option">4</li><li data-value="children" class="option">5</li><li data-value="children" class="option">6</li><li data-value="children" class="option">7</li><li data-value="children" class="option">8</li><li data-value="children" class="option">9</li><li data-value="children" class="option">10</li></ul></div>               
                                        </div>
                                    </div>
                                </div>
                                <input type="hidden" name="page" value="1">
