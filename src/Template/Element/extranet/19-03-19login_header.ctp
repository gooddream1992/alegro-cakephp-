        ...
        <ul class="navbar-nav">
            <?php if($paramAction != "basicTab"){ ?>
                    ...
                    <li class="nav-item <?php if($paramAction=='aboutus'){?> active active1 <?php } ?>">
                        <a class="nav-link" onclick="openCity(event, 'Listings')"><?php echo __('Accommodations');?></a>
                    </li>
            ...
            <?php } ?>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="profileDropdownMenuLink">
                            ...
                            <a class="dropdown-item" href="basic_tab"><?php echo __('New Accommodation');?></a>
