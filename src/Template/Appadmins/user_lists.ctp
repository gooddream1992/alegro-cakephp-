        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box" style="height:80px;">
                    ...
                    <div class="col-sm-5">
                        <div class="">
                            <label>Total number of users in a day <span><?php echo $dayPassanger; ?> </span></label> <br/>
                            <label><p>Total number of users in the current month <?php echo $monthPassanger; ?></p></label><br/>
                            <label><p>Total number of users in the current year <?php echo $yearPassanger; ?></p></label><br/>
