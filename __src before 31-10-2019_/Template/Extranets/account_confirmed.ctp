    ...
    <div class="modal-dialog modal-confirm">
        <div class="modal-content" style='width: 100%;height: auto;'>
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo __('All Set!'); ?></h4>	
            </div>
            <div class="modal-body">
                <p class="text-center"><?php echo __('Your account has been successfully confirmed. You can now log into your Alegro account.'); ?></p>
            </div>
            <div class="modal-footer">
                <button class="btn btn-success btn-block" onclick='getClose("accountConfirmed")'><?php echo __('OK'); ?></button>
            </div>
        </div>
    </div>
</div> 