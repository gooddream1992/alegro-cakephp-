            ...
            <tr>
                <td style="text-align: center;">
                    <div style="float: left; width: 50%; padding-bottom: 10px;">
                        <p style="color: #000; font-weight: normal; text-align: left; line-height: 22px;"><span style="font-weight: bold; color: #000;">Invoice: <span style="font-weight:normal;"><?= $val->booking_no; ?></span></span>
            ...
            <tr style=" display: inline-block; width: 96%; padding: 14px 16px;">
                <td style=" display: inline-block; width: 100%;">
                    <ul style=" margin: 0; padding: 0; width: 30%; float: right;">
                        <li style="margin:5px 0;line-height: 30px;display: inline-block;width: 100%;font-weight: bold;font-size: 15px;color: #000;text-align: left;">Subtotal:<span style="float: right;font-weight: normal;"><?= $bookingdetails->total_cost; ?></span></li>
                        <li style="margin:5px 0;line-height: 30px;display: inline-block;width: 100%;font-weight: bold;font-size: 15px;color: #000;text-align: left;">Service Fee:<span style="float: right;font-weight: normal;">0</span></li>
                        <li style="margin:5px 0;line-height: 30px;display: inline-block;width: 100%;font-weight: bold;font-size: 15px;color: #000;text-align: left;">Total:<span style="float: right;font-weight: normal;"><?= $bookingdetails->total_cost; ?></span></li>
                        <li style=" margin-top: 7px; background: #eee; padding: 10px 10px; border-bottom: 3px solid #f9d456; display: inline-block; width: 97%; color: #000; font-weight: bold;">Paid: <span style="float: right;font-weight: normal;">AOA <?= changeFormat(number_format($bookingdetails->total_cost,2)); ?></span></li>
                    </ul>
                </td>
            </tr>
            <tr>
...
<div style="font-size: 15px;color: #000;margin: -50px 0px 0px 804px;line-height: 23px;width: 727px;text-align: center;">Alegro Holdings, LDA | Rua Rey Katiavala, nº118, Prédio da Angop, 7ºD, Apt 45 | Bairro Ingombota | Luanda - Angola | NIF: 5000172790 | www.alegro.co.ao | apoio@alegro.co.ao | +244 929 259 256 | +244 929 259 258</p>
</div>
