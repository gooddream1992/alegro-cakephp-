    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-sm-4 text-center contact-infos-box">
                    ...
                    <div class="col">
                        <div class="contact-infos-icon">
                            <span class="fa-stack fa-2x">
                                ...
                                <i class="fab fa-whatsapp fa-stack-1x fa-inverse" style="color:black;"></i>
                            </span>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <?php echo __('+244 929 259 256 / +244 929 259 258');?>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="contact-infos-icon">
                            <span class="fa-stack fa-2x">
                                <i class="fas fa-circle fa-stack-2x" style="color:#f9d749;"></i>
                                <i class="fas far fa-envelope fa-stack-1x fa-inverse" style="color:black;"></i>
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-4 text-center contact-infos-box">
                <div class="row">
                    <div class="col">
                        <div class="contact-infos-icon">
                            <span class="fa-stack fa-2x">
                                <i class="fas fa-circle fa-stack-2x" style="color:#f9d749;"></i>
                                <i class="fas far fa-map-marker-alt fa-stack-1x fa-inverse" style="color:black;"></i>
                            </span>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <?php echo __('Rua Rey Katiavala, 7ºD, Apt 45');?>
                    </div>
                </div>
            </div>
