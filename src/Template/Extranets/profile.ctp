            ...
            <div class="col-md-10">
                <div class="head-section">
                    <div class="Profile ">
                        ...
                        <h1><?php echo __('Tell us who you are'); ?><span><?php echo __('Please provide your full legal name here for your contract with Alegro. If additional information is needed to list your property, we will contact you.'); ?></span></h1>


                        <div class="recommended">
                            <h5><?php echo __('Add/Change profile photo (optional)'); ?> <span><?php echo __('Put a face to your name! We will add this to your profile, and share it with future hosts and guests.'); ?></span></h5>
                            <div class="upload-section">
                                <ul>
                                    <li>
                                        <div>
                                            <div id="cropContainerModal"><?php if ($usr_all_det->profile_photo != "") { ?> <img src='<?= HTTP_ROOT . $usr_all_det->profile_photo; ?>' alt="usr" style="border-radius: 50%;width: 76px;"><?php } else { ?><i class="fas fa-user-circle"></i><?php } ?></div>

                                        </div>
                                    </li>
                                    <li><p><?php echo __('Your picture matters. Pick a clear and friendly-looking one, to increase bookings.'); ?></p></li>
                                    <li><span class='btn btn-default' class="btn btn-default" style="padding: 10px;margin: -2px 0px 0px 122px;border: 1px solid black;color: black;text-transform: uppercase;" onclick="$('.cropControlUpload').click();"><?php echo __('ADD/CHANGE PROFILE PHOTO'); ?></span></li>
                                </ul>
                            </div>
                        </div>
                        <?= $this->Form->create('', ['type' => 'post', 'id' => 'profile-page']); ?>
                        <div class="recommended">
                            <h5><?php echo __('Main Info'); ?></h5>
                            <div class="name">
                                <ul>							
                                    <li>
                                        <div>
                        ...
                        <div class="recommended">
                            <h5><?php echo __('Your Contact'); ?></h5>
                            <div class="contact">
                                <ul>							
                                    <li>
                                    ...
                                    <li style="margin-top: -25px;margin-left: 295px;">
                        ...
                        <div class="recommended">
                            <h5><?php echo __('Bank Account'); ?></h5>
                            <div class="contact">
                                <ul>							
                                    <li>
                                    ...
                                    <li>
                                        <div>
                                            ...
                                            <select name="bank_name" id="bank_name" class="form-control">
                                                <option value="" selected disabled><?php echo __('Bank Name'); ?></option>
                        ...
                        <div class="recommended">
                            <h5><?php echo __('Your Location'); ?></h5>
...
<!--                                    <select id="state" name="state" onchange="mapStateChecker(this.value)" required>-->
                        ...
                        <div class="recommended">	
                            <h5><?php echo __('Describe Yourself'); ?></h5>
                            <div class="about-you">
                                <textarea rows="5" name="description" type="text" id="userDescription" class="form-control" style="margin: 0px -1px 0px 0px; width: 830px; height: 319px;" placeholder="Description"><?= $edit_det->description; ?></textarea>
                            </div>
                        </div>
                        <div class="last-section">
                            ...
                            <ul>
                                ...
                                <li><a href="<?= HTTP_ROOT; ?>extranets/photos/<?= @$id; ?>"><?php echo __('PREVIOUS'); ?></a></li>
                            </ul>
                        </div>									
                        <?= $this->Form->end(); ?>											
                    </div>	
