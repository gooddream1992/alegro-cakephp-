                            ...
                            <tr>
                                <td align="center" valign="top">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF;border-color:#E5E5E5; border-style:solid; border-width:0 1px 1px 1px;" width="100%" class="tableCard">
                                        ...
                                        <tr>
                                            <!-- Header Top Border // -->
                                            <td height="3" style="background-color:#fff;font-size:1px;line-height:3px;" class="topBorder" >&nbsp;</td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td align="center" valign="top" style="padding-bottom:40px" class="imgHero">
                                                ...
                                                <a href="javascript:;" target="_blank" style="text-decoration:none;">
                                                    <img src="<?php echo HTTP_ROOT ?>img/user-welcom.png" width="600" alt="" border="0" style="width: 20%;max-width:600px;height:auto;display:block;padding-top: 39px;" />
                                                </a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td align="center" valign="top" style="padding-bottom:5px;padding-left:20px;padding-right:20px;" class="mainTitle">
                                                <!-- Main Title Text // -->
                                                <h2 class="text" style="color:#000000;font-size: 20px;font-weight: bold;font-style:normal;letter-spacing:normal;line-height:36px;text-transform:none;text-align:center;padding:0;margin:0;">
                                                   <?php echo __('Hi, Rafael');?> <?php  echo $user->user_detail->first_name;?> <?php  echo $user->user_detail->sur_name;?>
                                                </h2>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td align="center" valign="top" style="padding-bottom:30px;padding-left:20px;padding-right:20px;" class="subTitle">
                                                <!-- Sub Title Text // -->
                                                <h4 class="text" style="color: #000000;font-size: 15px;font-style:normal;letter-spacing:normal;line-height:26px;text-transform:none;text-align:center;padding:0;margin:0;">
                                                    <?php echo __('Your account has been successfully created');?>
                                                </h4>
                                            </td>
                                        </tr>
                                                    ...
                                                    <tr>
                                                        <td align="center" valign="top" style="padding-bottom:20px;" class="catagoryLinks">
                                                            ...
                                                            <a href="#" target="_blank" style="display:inline-block;">
                                                                <img src="<?php echo HTTP_ROOT ?>img/catagory-1.png" alt="" width="60" border="0" style="height:auto; width:100%; max-width:60px; margin-left:2px; margin-right:2px" />
                                                            </a>

                                                            <a href="#" target="_blank" style="display:inline-block;">
                                                                <img src="<?php echo HTTP_ROOT ?>img/catagory-2.png" alt="" width="60" border="0" style="height:auto; width:100%; max-width:60px; margin-left:2px; margin-right:2px" />
                                                            </a>

                                                            <a href="#" target="_blank" style="display:inline-block;">
                                                                <img src="<?php echo HTTP_ROOT ?>img/catagory-3.png" alt="" width="60" border="0" style="height:auto; width:100%; max-width:60px; margin-left:2px; margin-right:2px" />
                                                            </a>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tableTitleDescription">
                                                    <tr>
                                                        <td align="center" valign="top" style="padding-bottom:10px;" class="mediumTitle">
                                                            <!-- Medium Title Text // -->
                                                            <p class="text" style="color:#000000;font-size:18px;font-weight: bold;font-style:normal;letter-spacing:normal;line-height:26px;text-transform:none;text-align:center;padding:0;margin:0;">
                                                                <?php echo __('Next step:');?>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td align="center" valign="top" style="padding-bottom:20px;" class="description">
                                                            <!-- Description Text// -->
                                                            <p class="text" style="color: #000000;font-size:15px;font-style:normal;letter-spacing:normal;line-height:22px;text-transform:none;text-align:center;padding:0;margin:0;">
                                                                
                                                                <?php echo __('Go check your inbox and confirm your account ASAP. Once the account is confirmed you can then log into your profile using the credentials you´ve used upon registration.');?>
                                                            ...
                                                            <table align="center" border="0" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    <td align="center" class="ctaButton" style="background-color:#f9d749;padding-top:12px;padding-bottom:12px;padding-left:35px;padding-right:35px;border-radius:.25rem">
                                                                        <!-- Button Link // -->
                                                                        <a class="text" href="<?php echo $mail_url;?>" target="_blank" style="color:#000; font-size:15px;  font-style:normal;letter-spacing:1px; line-height:20px; text-transform:uppercase; text-decoration:none; display:block">
                                                                            <?php echo __('OK');?>
                                                                        </a>
                                                                    </td>
                                                                </tr>
