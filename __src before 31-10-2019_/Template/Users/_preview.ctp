                                                    ...
                                                    <div class="non-refund-price" style="float:right">
                                                        ...
                                                        <p class="text text-success" style="font-weight: normal;font-size: 15px;">
                                                            <?php if ($htl_rm_pric_frea > 0) { ?>
                                                                ...
                                                                if ($dateDifference >= $longDays) {
                                                                    if (!empty($this->request->session()->read("CURRENCY"))) {
                                                                        echo $this->request->session()->read("CURRENCY") . ' ' . number_format($this->User->priceConvert($this->request->session()->read("CURRENCY"), $dateDifference * $htl_fixrm_pric1), 2);
                                                                        ?> <?= ' ' . __("for"); ?> <?= $dateDifference; ?><?php
                                                                    } else {
                                                                        echo 'AOA ' . $this->User->changeFormat(number_format($dateDifference * $htl_fixrm_pric1, 2));
                                                                        ?> <?= ' ' . __("for"); ?> <?= $dateDifference; ?><?php
                                                                    }
                                                                } else {
                                                                    if (!empty($this->request->session()->read("CURRENCY"))) {
                        ...
                        <div class="Similar-right-box">
                            ...
                            if (!empty($iOne[0])) {
                                ...
                                <div class="Hotel-Presidente">
                                    ...
                                    <div class="sc-eMRERa hAZDpl sc-bdVaJa cDiPQh"><div class="sc-EHOje hSElwR" font-size="1" color="black"><?php echo is_nan($this->User->totalRating($iOne[0])) ? 0 : $this->User->totalRating($iOne[0]); ?>/5</div></div>
                                    ...
                                    <div class="sc-ileJJU gbSOWI sc-bdVaJa kRGLvU"><div class="sc-EHOje tkrSK" color="green" font-size="2">                                        
                                            <?php
                                            if (!empty($this->request->session()->read("CURRENCY"))) {
                                                echo $this->request->session()->read("CURRENCY") . ' ' . number_format($this->User->priceConvert($this->request->session()->read("CURRENCY"), $this->User->propertyPrice($fstHotel->id)), 2);
                                            } else {
                                                echo 'AOA ' . $this->User->changeFormat(number_format($this->User->propertyPrice($fstHotel->id), 2));
                                            }
                                            ?>
                                        </div></div>
                                ...
                                <div class="Hotel-Trópico">
                                    ...
                                    <div class="sc-eMRERa hAZDpl sc-bdVaJa cDiPQh"><div class="sc-EHOje hSElwR" font-size="1" color="black"><?php echo is_nan($this->User->totalRating($iOne[1])) ? 0 : $this->User->totalRating($iOne[1]); ?>/5</div></div>
