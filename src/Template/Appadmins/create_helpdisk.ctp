    ...
    <section class="content-header">
        <h1>
            ...
            if ($id) {
                ...
                echo "Create HelpDisk";
            }
            ?>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo HTTP_ROOT . 'appadmins' ?>"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active"><a  href="<?= h(HTTP_ROOT) ?>appadmins/view_helpdisk"> <i class="fa fa-list"></i>HelpDisk List</a></li>
        </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <div class="box-footer">
                        ...
                        <?php
                        if ($id) {
                            echo $this->Form->button('Update helpdisk', ['class' => 'btn btn-primary', 'style' => 'float:left;margin-left:15px;']);
                        } else {
                            echo $this->Form->button('Create helpdisk', ['class' => 'btn btn-primary', 'style' => 'float:left;margin-left:15px;']);
                        }
                        ?>
                    </div>
                    <?= $this->Form->end() ?>
