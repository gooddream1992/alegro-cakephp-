        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-lg-12 col-md-12">
                <div class="reservation-head-box">
                    <!-- -----------******************move this section********************----------->
                    <div class="reservation-headbox-right reservation-headbox-right-display-none" style="display: none;">
                        ...
                        <div class="upd-res">
                            ...
                            <div class="upd-res-box">
                                <ul>
                                    <?php
                                    $Previous_date_x = date_format($all_data->check_in, 'Y-m-d');
                                    $Previous_date_x1 = new DateTime($Previous_date_x);
                                    $Previous_date_x1->modify('-2 days');
                                    $Previous_date_y = $Previous_date_x1->format('Y-m-d');

                                    /*                                     * *********************** PAYMENT MODE : MultiCaixa ********************** */
                                    if ($all_data->payment_method == "MultiCaixa") {
                                        ?>
                                        <?php
                                        if (($all_data->payment_status == 3)) {
                                            if ($Previous_date_x <= date('Y-m-d')) {
                                                ?>
                                                <li
                                                    <?php if (($all_data->user_htl_reach_status == 2) || ($all_data->user_htl_reach_status == 1) || ($all_data->user_htl_reach_status == 3) || ($all_data->user_htl_reach_status == 5)) { ?> class= 'disabled' <?php } ?>
                                                    <?php if ($all_data->user_htl_reach_status == 2) { ?> style="background:#f9d749;" <?php } ?>
                                                    >
                                                    <a  <?php
                                                    if (($all_data->user_htl_reach_status == 2) || ($all_data->user_htl_reach_status == 1) || ($all_data->user_htl_reach_status == 3) || ($all_data->user_htl_reach_status == 5)) {

                                                    } else {
                                                        ?>data-toggle="modal" data-target="#myModal3ad" <?php } ?> >
                                                            <?php
                                                            if ($all_data->user_htl_reach_status == 2) {
                                                                echo __("Marked As Show");
                                                            } else {
                                                                echo __("Mark As Show");
                                                            }
                                                            ?>
                                                    </a>
                                                </li>
                                                <li
                                                    <?php if (($all_data->user_htl_reach_status == 2) || ($all_data->user_htl_reach_status == 1) || ($all_data->user_htl_reach_status == 3) || ($all_data->user_htl_reach_status == 5)) { ?> class= 'disabled' <?php } ?>
                                                    <?php if ($all_data->user_htl_reach_status == 1) { ?> style="background:#f9d749;" <?php } ?>
                                                    >
                                                    <a <?php
                                                    if (($all_data->user_htl_reach_status == 1) || ($all_data->user_htl_reach_status == 2) || ($all_data->user_htl_reach_status == 3) || ($all_data->user_htl_reach_status == 5)) {

                                                    } else {
                                                        ?>data-toggle='modal' data-target='#myModal4ad'<?php } ?> >
                                                            <?php
                                                            if ($all_data->user_htl_reach_status == 1) {
                                                                echo __("Marked As No-Show");
                                                            } else {
                                                                echo __("Mark As No-Show");
                                                            }
                                                            ?>
                                                    </a>
                                                </li>
                                                ...
                                                <li class= 'disabled' >
                                                    <a href='javascript:void(0);'>
                                                        <?php echo __("Mark As Show"); ?>
                                                    </a>
                                                </li>
                                                <li class= 'disabled' >
                                                    <a href='javascript:void(0);'>
                                                        <?php echo __("Mark As No-Show"); ?>
                                                    </a>
                                                </li>
                                                <?php
                                                if (($all_data->user_htl_reach_status == 1)) {
                                                    ...
                                                    ?>
                                                    <?php if ($all_data->cancel_policy == "Flexible") { ?>
                                                        <?php
                                                        if ($Previous_date_x >= date('Y-m-d')) {
                                                            ?>
                                                            <li <?php if (($all_data->user_htl_reach_status == 3)) { ?> class="disabled" style="background:#f9d749;" <?php } ?>>
                                                                <a <?php
                                                                if (($all_data->user_htl_reach_status == 3)) {

                                                                } else {
                                                                    ?>  data-toggle="modal" data-target="#myModal1ad" <?php } ?>>
                                                                        <?php
                                                                        if (($all_data->user_htl_reach_status == 3)) {
                                                                            echo __("Cancelled");
                                                                        } else {
                                                                            echo __("Cancel Booking");
                                                                        }
                                                                        ?>
                                                                </a>
                                                            </li>
                                            ...
                                            ?>
                                            <?php if ($all_data->cancel_policy == "Flexible") { ?>
                                                <?php if ($Previous_date_x < date('Y-m-d')) { ?>
                                                    <li>
                                                        <a  data-toggle="modal" data-target="#myModal1ad"><?php echo __("Cancel Booking"); ?></a>
                                                    </li>
                                                <?php } ?>
                                            <?php } ?>

                                            <?php if ($all_data->cancel_policy == "Moderate") { ?>
                                                <?php if ($Previous_date_y > date('Y-m-d')) { ?>
                                                    <li>
                                                        <a  data-toggle="modal" data-target="#myModal1ad"><?php echo __("Cancel Booking"); ?></a>
                                                    </li>
                                                <?php } ?>
                                            ...
                                            <?php if ($all_data->cancel_policy == "Strict") { ?>
                                                <?php if ($Previous_date_x > date('Y-m-d')) { ?>
                                                    <li>
                                                        <a  data-toggle="modal" data-target="#myModal1ad"><?php echo __("Cancel Booking"); ?></a>
                                                    </li>
                                            ...
                                            <?php if ($all_data->cancel_policy == "Flexible") { ?>
                                                <?php if (($all_data->payment_status == 4) || ($all_data->user_htl_reach_status == 5) || ($all_data->user_htl_reach_status == 1)) { ?>
                                                    <li <?php if (($all_data->user_htl_reach_status == 5)) { ?> class="disabled" style="background:#f9d749;" <?php } ?> >
                                                        <a <?php if (($all_data->user_htl_reach_status != 5)) { ?>data-toggle="modal" data-target="#myModal2ad" <?php } ?>><?php
                                                            if ($all_data->user_htl_reach_status == 5) {
                                                                echo __("Refunded");
                                                            } else {
                                                                echo __("Issue a Refund");
                                                            }
                                                            ?></a>
                                                    </li>
                                                <?php } ?>
                                            ...
                                            if (($all_data->payment_status == 1)) {
                                                ?>
                                                <li style="background:#f9d749;"  >
                                                    <a href='javascript:void(0);'><?= __("Awaiting Payment"); ?></a>
                                                </li>
                                            <?php } ?>
                                            <li class= 'disabled' >
                                                <a href='javascript:void(0);'>
                                            ...
                                            <?php if (($all_data->payment_status == 4)) { ?>
                                                <li class= 'disabled' <?php if (($all_data->payment_status == 4)) { ?> style="background:#f9d749;" <?php } ?> >
                                                    <a href='javascript:void(0);'>
                                                        <?php
                                                        if (($all_data->payment_status == 4)) {
                                                            echo __("Cancelled");
                                                        }
                                                        ?>
                                                    </a>
                                        ...
                                        if (($all_data->payment_status == 2)) {
                                            ?>
                                            <li class= 'disabled' style="background:#f9d749;">
                                                <a href='javascript:void(0);'>
                                    ...
                                    if ($all_data->payment_method == "No Alojamento") {
                                        ...
                                        if ($all_data->cancel_policy == "Flexible") {
                                            if ($Previous_date_x > date('Y-m-d')) {
                                                ?>
                                                <li  <?php if (($all_data->user_htl_reach_status == 3)) { ?>  class= 'disabled' <?php } ?>>
                                                    <a <?php if (($all_data->user_htl_reach_status != 3)) { ?>data-toggle="modal" data-target="#myModal1a" <?php } ?> ><?= __("Change Booking Dates"); ?></a>
                                                </li>
                                                <?php
                                            }
                                        }
                                        ...
                                        if ($Previous_date_x <= date('Y-m-d')) {
                                            ?>
                                            <li
                                                <?php if (($all_data->user_htl_reach_status == 1) || ($all_data->user_htl_reach_status == 2)) { ?> class= 'disabled' <?php } ?>
                                                <?php if ($all_data->user_htl_reach_status == 2) { ?> style="background:#f9d749;" <?php } ?>
                                                >
                                                <a <?php
                                                if (($all_data->user_htl_reach_status == 1) || ($all_data->user_htl_reach_status == 2) || ($all_data->user_htl_reach_status == 3) || ($all_data->user_htl_reach_status == 5)) {
                    ...
                    <div class="reserv-box-left">
                        <div class="reservation-headbox-laft">
                            <div class="reservation-box-left">
                                ...
                                <ul>
                                    <li><?= __("Your Stay"); ?>:<span><?php echo $difff = timeago(date_format($all_data->check_in, 'Y-m-d'), date_format($all_data->check_out, 'Y-m-d')); ?> <?php
                                            ...
                                            ?></span></li>
                                    <?php if ($all_data->booking_type == 1) { ?>
                                        <li><?= __("Booking type"); ?>:<span><?= __('Entire Place'); ?></span></li>
                                        <?php
                                    }
                                    if ($all_data->booking_type == 2) {
                                        ?>
                                        <li><?= __("Booking type"); ?>:<span><?= __('Private Room'); ?></span></li>
                                    ...
                                    <?php } ?>
                                    <li><?= __("Payment Method"); ?>: <span><?= $all_data->payment_method; ?></span> </li>
                                </ul>
                            </div>
                            <div class="reserva-box-right">
                                ...
                                <ul>
                                    ...
                                    <li><?= __("Alegro Commission"); ?>: <span><?= @$all_data->service_fee; ?>% (AOA <?= changeFormat(number_format($all_data->total_room_fee * ($all_data->service_fee / 100), 2)); ?>)</span> </li> <br/>
                                    <li><?= __("Cancellation Policy"); ?>: <span><?= __(@$all_data->cancel_policy); ?></span> <br>                     <span style="width: 508px;margin-top: 5px;">
                                            <?php
                                            if ($all_data->cancel_policy == 'Flexible') {
                                            ...
                                            }if ($all_data->cancel_policy == 'Moderate') {
                                            ...
                                            }if ($all_data->cancel_policy == 'Strict') {
                        ...
                        <div class="reservation-headbox-laft2">
                            <h5><?php
                                if ($all_data->booking_type == 1) {
                                    echo $this->User->getHotelName($all_data->booking_no);
                                } if ($all_data->booking_type == 2) {
                                    echo $this->User->getDataForRoom($all_data->room_id)->bed_name;
                                }
                                ?><span>AOA <?= changeFormat(number_format($all_data->total_room_fee, 2)); ?></span></h5>
                            <ul>
...
<!--                        <span class="input-group-addon">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary send-m" onclick="return reset_date()"><?= __("Change"); ?></button>
...
<div class="modal fade new-message delet-message" id="myModal3ad" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p><?= __("Are you sure you want to mark this booking as Show?"); ?></p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default cancel-m" data-dismiss="modal"><?= __("Ignore"); ?></button>
...
<div class="modal fade new-message delet-message" id="myModal4ad" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p><?= __("Are you sure you want to mark this booking as No-Show?"); ?></p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default cancel-m" data-dismiss="modal"><?= __("Ignore"); ?></button>
