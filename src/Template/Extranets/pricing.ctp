                ...
                <div class="head-section">
                    ...
                    <div class="pricing-page">
                        ...
                        if ($this->User->getBookingRoomType($id) == 1) {
                            foreach ($availableBeds as $valss) {
                                $accomoo += $this->User->getAccomodation($valss->id);
                            }
                        }
                        foreach ($availableBeds as $val) {
                            ...
                            <?php
                            if ($this->User->getBookingRoomType($id) == 1) {
                                $propPri = $this->User->proPrice($id, 0);
                                ?>
                                <input type="hidden" name="sub_id<?= $cont; ?>" value="0">
                                <?php
                            } else {
                            ...
                            <div class="panel panel-default price-configuration m-t-3">
                                <div class="panel-body">
                                    ...
                                    <h4>
                                        ...
                                        ?> <?php echo __('can accommodate up to'); ?>
                                        <?php
                                        if ($this->User->getBookingRoomType($id) == 1) {
                                            echo $accomo = $accomoo;
                                        } else {
                                            echo $accomo = $this->User->getAccomodation($val->id);
                                        }
                                        if ($accomo == 1) {
                                            echo ' ' . __('person');
                                        } else {
