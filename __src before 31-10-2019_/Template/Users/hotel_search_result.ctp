...
<section id="search-results-body">
 ...
 <?php }else{ if (@$result_property_count != 0) { ?>
                    ...
                    <?php } ?>
                        ...
                        //pj($chkhotelproAsc);
                        $chkhotelproAsc = $this->User->chkhotelproAsc($result_property);
                        foreach ($chkhotelproAsc as $list1) {
                            ...
                            <div class="hotel-lsting <?php if($boostStatus ==1 ){ ?>sponsore-list<?php } ?>">
                                ...
                                <div class="hotel-lsting-middle" style="width: 48%;">
                                    ...
                                    <p><?= $this->User->propertySize($list1->property_id, $guest); ?> <?php echo __('Sqm') ?> <br>
                                        <i class="fas fa-users"></i> <?php
                                        //echo $list->id;
                                ...
                                <div class="hotel-lsting-right">
                                    <h6><?php echo $this->User->reviewCount($list1->property_id); ?> <?php echo __('reviews') ?><span><?php echo is_nan($this->User->totalRating($list1->property_id)) ? 0 : $this->User->totalRating($list1->property_id); echo "/5"; ?></span></h6>
                            ...
                            <?php } ?>
                                    <div class="form-group" style="margin:0; float: right;">
                                        <label>&nbsp;</label>
                                        <a href="<?= HTTP_ROOT; ?>preview/<?= $list1->property_id; ?>?<?= $_SERVER['QUERY_STRING']; ?>" target="_blank"><button type="button" class="btn btn-primary hvr-grow btn-fill"><?php echo __('Check Availability') ?></button></a>
                                    </div>
                                </div> 
                            </div>
