                    ...
                    <div class="row">
                            ...
                            <div class="row align-items-center search-form p-top-12">
                                <div class="col-md-12" id="A3">
                                    <div class="search-display">
                                        <div class="form-group">
                                            ...
                                            <input required="" type="text" class="form-control box1" id="from" name="from" placeholder="<?php echo __('Origin'); ?>" onkeyup="loc_data()" autocomplete="off">
                                            <img src="http://php.microfinet.com/flight-booking/img/icon/icon_10.png" class="formIcon box1_img_h">
                                            <img src="http://php.microfinet.com/flight-booking/img/icon/icon_10_y.png" class="formIcon box1_img">
                                        </div>
                                        <div id="display" style="display:none;">
                                ...
                                <div class="col-md-6" id="A1">
                                    ...
                                    <div class="form-group" style="margin-bottom: 0px;">
                                        ...
                                        <input required="" type="text" data-language="en" class="datepicker-here form-control box3" placeholder="Departure" id="departure" name="<?php echo __('Check-in Date'); ?>" autocomplete="off" onblur="myInput()">
                                        <img src="http://php.microfinet.com/flight-booking/img/icon/icon_3.png" class="formIcon box3_img_h">
                                        <img src="http://php.microfinet.com/flight-booking/img/icon/icon_3_y.png" class="formIcon box3_img">
                                    </div>
                                </div>
                                <div class="col-md-6" id="return_date1">
                                    <div class="form-group" style="margin-bottom: 0px;">
                                        <label><?php echo __('Check-out Date'); ?>:</label>
                                        <input type="text" data-language="en" class="datepicker-here form-control box4" placeholder="<?php echo __('Check-out Date'); ?>" id="return_date" name="return" autocomplete="off">
                                        <img src="http://php.microfinet.com/flight-booking/img/icon/icon_4.png" class="formIcon box4_img_h">
                                        <img src="http://php.microfinet.com/flight-booking/img/icon/icon_4_y.png" class="formIcon box4_img">
                        ...
                        <div class="col-md-12 no-padding">
                           ...
                           <div class="form-group">
                                        ...
                                        <select id="cabin" name="cabin" class="form-control airlinehide box6" required>
                                            <option value="" selected><?php echo __('1'); ?></option>
                                            <option value="Economy"><?php echo __('2'); ?></option>
                                            <option value="Business"><?php echo __('3'); ?></option>
                                            <option value="First"><?php echo __('4') ?></option>
                                        </select>
                                        <i class="fa fa-angle-down formIconArrow"></i>
                                    </div>                         
