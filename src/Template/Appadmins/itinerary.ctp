...
<div class="email-templ" style="width: 85%; margin: 0 auto;">
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-top: 4%; text-align: center;">
        <tr>
            <td style=""><img style="width: 200px;" src="<?= $this->Url->image('header-logo.png'); ?>"></td>
        </tr>
        <tr>
            <td><h5 style="    margin-top: 20px; margin-bottom: 20px; text-align: left; font-size: 20px; border-bottom: 3px solid #f9d749; padding: 10px 11px; border-left: 3px solid #f9d749; border-bottom-left-radius: 22px;">Dados da Reserva </h5></td>
        </tr>
    </table>
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="text-align: left; margin-bottom: 5%;">
        <tr style="font-size: 18px;">
            ...
            <th style=" padding-bottom: 15px;">Número do Bilhete</th>
            <th style=" padding-bottom: 15px;">Número da Reserva</th>
            <th style=" padding-bottom: 15px;">Data da Reserva</th>
        </tr>
        <tr>
                <td style="font-size: 15px;">AFONSO/PEDRO</td>
            <td style="font-size: 15px;"><?= $bookingdetails->payment_id; ?></td>
            <td style="font-size: 15px;">D37SDA</td>
            <td style="font-size: 15px;"><?= $bookingdetails->purches_date->format('d/m/Y'); ?></td>
        </tr>
    </table>
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-top: 1%;">
        <tr>
            <td><h5 style=" margin-bottom: 20px; text-align: left; font-size: 20px; border-bottom: 3px solid #f9d749; padding: 10px 11px; border-left: 3px solid #f9d749; border-bottom-left-radius: 22px;">Rota </h5></td>
        </tr>
    ...
    foreach ($fullbookingdetails as $val) {
        ...
        ?>
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-top: 0; border-bottom: 3px solid #f9d749;  padding-bottom: 30px; margin-bottom: 12px; text-align: left;">

            <tr>
                <td colspan="4">
                    <h5 style=" font-size: 18px; font-weight: normal; margin: 10px 0 18px 0">
            ...
            <tr style="font-size: 18px;">
                ...
                <th style=" padding-bottom: 15px;">Aeronave</th>
            </tr>
            ...
            <tr style="font-size: 18px;">
                ...
                <th style=" padding-bottom: 15px; padding-top: 15px;">Bagagem de porão</th>
            </tr>
            <tr style="font-size: 15px;  vertical-align: top; margin-bottom: 15px;">
                ...
                <td><p style="font-size: 15px; margin: 0px 0 0;">1 Peça(s) / Mala(s) 5Kg</p></td>
                <td><p style="font-size: 15px; margin: 0px 0 0;">2 Peça(s) / Mala(s) 23Kg</p></td>
            </tr>
        </table>
    <?php } ?>
</div>
...
<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-top: -15px !important;
    background: #fff;">
        <tbody><tr>
                <td><h5 style=" margin-bottom: 20px; text-align: left; font-size: 20px; border-bottom: 3px solid #f9d749; padding: 10px 11px; border-left: 3px solid #f9d749; border-bottom-left-radius: 22px;">Custo Detalhado </h5></td>
            </tr>
        </tbody></table>
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="text-align: left;">
        <tbody>
            <tr style="font-size: 15px; vertical-align: top;">
                <td><b>Forma de Pagamento:</b> MultiCaixa <br>
                    <b>Tarifa Aérea:</b> USD 265,00 <br>
                    <b>Tarifa Equivalente Paga:</b> AOA 83.711,00<br>
                    <b>Taxas da Companhia Aérea:</b> AOA 17.846,00<br>
                    <b>Valor Total:</b> AOA 101.557,00<br></td>
            </tr>
        </tbody></table>

    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-top: 30px !important;
    background: #fff;">
        <tbody><tr>
                <td><h5 style=" margin-bottom: 20px; text-align: left; font-size: 20px; border-bottom: 3px solid #f9d749; padding: 10px 11px; border-left: 3px solid #f9d749; border-bottom-left-radius: 22px;">Agência </h5></td>
            </tr>
        </tbody></table>
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="text-align: left;">
        <tbody><tr style="font-size: 18px;">
            ...
            <tr style="font-size: 15px; vertical-align: top;">
                <td>Alegro Holdings, LDA<br>
                    Rua Rey Katiavala, Prédio da Angop, 7ºD, Apt 45<br>
                    Luanda - Angola<br>
                    NIF: 5000172790<br>
                    Tlf: +244 929 259 256 / +244 929 259 258<br>
                    Email: geral@alegro.co.ao<br>
                    Website: www.alegro.co.ao<br></td>
                <td style="text-align: right;
                    position: relative;
                    top: -50px;">
                    <img style="width: 80px;" src="<?= $this->Url->image('travelport-digital.png'); ?>">
                    <p style="line-height: 24px;margin: 13px 0 0;font-size: 15px;">P7116701</p>
                </td>
            </tr>
        </tbody></table>
...
<div class="email-templ" style="width: 85%; margin: 0 auto;">
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-top: 1%;">
        <tr>
            <td><h5 style=" margin-bottom: 20px;margin-top: 0px; text-align: left; font-size: 20px; border-bottom: 3px solid #f9d749; padding: 10px 11px; border-left: 3px solid #f9d749; border-bottom-left-radius: 22px; color: #000">Contactos </h5></td>
        </tr>
    </table>
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="text-align: left;">

        <tr style="font-size: 15px;">
            <td style="padding: 8px 0;width: 45%;">Call Centre (Centro de Apoio ao Cliente)</td>
            <td style="padding: 8px 0;">apoio@alegro.co.ao</td>
            <td style="padding: 8px 0;width: 20%;">+244 929 259 256 / +244 929 259 258</td>
        </tr>
    </table>
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-top: 1%;">
        <tr>
            <td><h5 style=" margin-bottom: 20px; text-align: left; font-size: 20px; border-bottom: 3px solid #f9d749; padding: 10px 11px; border-left: 3px solid #f9d749; border-bottom-left-radius: 22px; color: #000">Notas </h5></td>
        </tr>
    </table>
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="text-align: left;">
        ...
        <tr style="font-size: 15px;">
            <td>
                <ul style="margin: 0;padding: 0px 17px;">
                    ...
                    <li style="padding: 5px 0;">O Alegro deseja-lhe boa viagem!</li>
                </ul>
            </td>
        </tr>	
    </table>
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-top: 5%;">
        <tr>
            <td><h5 style="margin-bottom: 20px;text-align: left;font-size: 20px;border-bottom: 3px dashed #f9d749;padding: 10px 0px;color: #000;">Informação importante para viajantes com bilhetes eletrónicos - leitura aconselhada </h5></td>
        </tr>
    </table>
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="text-align: left;margin-bottom: 4%;">

        <tr style="font-size: 15px; line-height: 25px;">
            <td>
                <p style="font-size: 15px; margin: 0;">O transporte e outros serviços disponibilizados pela transportadora estão sujeitos a condições de transporte, as quais são por este meio incorporadas por referência. Estas
