<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a  href="<?= h(HTTP_ROOT) ?>appadmins/view_admin"> <i class="fa fa-list"></i>Employee List</a></li>
        </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="exampleInputName">Employee Type <span style="color: red;">*</span></label>
                                <select name="type" class = "form-control" data-error= 'select one type'>
                                    <option value="3"  <?php if(@$editAdmin->type == 3) echo "selected"; ?> >Employee</option>
                                    <option value="5" <?php if(@$editAdmin->type == 5) echo "selected"; ?>>Operator</option>
                                    <option value="6" <?php if(@$editAdmin->type == 6) echo "selected"; ?>>Help-Desk</option>
                                </select>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                    ...
                    <div class="box-footer">
                        ...
                        if ($id) {
                            ...
                            echo $this->Form->button('Create employee', ['class' => 'btn btn-primary', 'style' => 'float:left;margin-left:15px;']);
                        }
                        ?>
                    </div>
                    <?= $this->Form->end() ?>
