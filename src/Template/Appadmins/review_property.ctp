                                ...
                                <div class="listing-tab col-md-12">
                                    <div class="tab-content">
                                        <ul>
                                            ...
                                            <li>
                                                <a href="#">What will guests book?</a>
                                                <span><?php
                                                    if ($all_details->booking_type == 1) {
                                                        echo __("Entire Place");
                                                    } else {
                                                        if ($all_details->booking_type == 2) {
                                            ...
                                            <?php if ($all_details->booking_type == 1) { ?>
                                                <li>
                                                    <a href="#">Pricing </a>
                                                    <span>AOA <?= changeFormat(number_format($this->User->propertyPrice($id), 2)); ?></span>
                                                </li>
                                            <?php } ?>
                                    ...
                                    <div class="tab-content">
                                        <ul>
                                            ...
                                            foreach ($propertyBed as $bed) {
                                                ...
                                                <?php if ($all_details->booking_type == 2) { ?>
                                                    <li>
                                                        <a href="#">Pricing</a>
