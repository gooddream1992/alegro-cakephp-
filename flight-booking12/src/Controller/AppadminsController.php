...
//$this->Custom->sendEmail($to, $from, $subject, $message);
    ...
    public function registeredProperty() {
        ...
        $intersect = $this->ExtranetsUserProperty->find('all')->contain(['location', 'pricing', 'description'])->where(['ExtranetsUserProperty.complete_ststus' => 1]);
