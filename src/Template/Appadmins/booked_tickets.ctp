                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                foreach ($bookings as $data) {
                                    ...
                                    ?>
                                    <tr>
                                        <td><?= 'ALE' . str_pad($data->id, 4, '0', STR_PAD_LEFT);?></td>
                                        <td><?=$user->name; ?></td>
                                        <td><?=$user->email;  ?></td>
...
<!--                                        <td>
                                            ...
                                            <td style="text-align: center;">
                                                <a href="<?php echo HTTP_ROOT . 'appadmins/flight-booking-overview/' . $data->id ?>" class="btn btn-info hint--top  hint" style="padding: 0 7px!important;" title="View Booking" target="_blank">
                                                    <i class="fa fa-eye"></i>
                                                </a> &nbsp;&nbsp;&nbsp;
                                                <a href="<?php echo HTTP_ROOT . 'appadmins/itinerary/' . $data->id ?>" class="btn btn-info hint--top  hint" style="padding: 0 7px!important;" title="View Itinerary" target="_blank">
                                                    <i class="fa fa-file"></i>
                                                </a> &nbsp;&nbsp;&nbsp;
                                                <a href="<?php echo HTTP_ROOT . 'appadmins/invoice/' . $data->id ?>" class="btn btn-info hint--top  hint" style="padding: 0 7px!important;" title="View Invoice" target="_blank">
