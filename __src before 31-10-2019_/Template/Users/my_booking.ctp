                                        ...
                                        <div class="hotel-lsting-middle">
                                            ...
                                            <h6><span><a href="#"><?= $property_details->property_size; ?> <?php echo __('Sqm') ?></a>
                                                    ...
                                                    <p style="float: left;"><i class="fas fa-users"></i> <?php
                                                        ...
                                                        <?php echo $this->User->stateName($pro_book->property_id, $guest).','.' '. $this->User->cityName($pro_book->property_id, $guest); ?>
                                                        <br>
                                                    ...
                                                    <div class="hotel-lsting-right">
                                                        <h6><?php echo $this->User->reviewCount($pro_book->property_id); ?> reviews<span><?php echo is_nan($this->User->totalRating($pro_book->property_id)) ? 0 : $this->User->totalRating($pro_book->property_id); ?>/5</span></h6>
                                                        ...
                                                        <div class="form-group" style="margin: 0 9px 0px 0px;">
                                                            ...
                                                            <?php } else { ?>
                                                                ...
                                                                <?php } else { ?>
                                                                    ...
                                                                    <button onclick="modal_open(<?= $pro_book->property_id; ?>, '<?= $pro_book->booking_no; ?>', '<?= $this->User->usrHelper($pro_book->property_user_id)->name; ?>', '<?= HTTP_ROOT . $this->User->usrdetHelper($pro_book->property_user_id)->profile_photo; ?>',<?= $pro_book->id; ?>)" type="button" class="btn btn-primary hvr-grow btn-fill" ><?php echo __('Review'); ?></button>                                                                
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer" style="background:#fff;">
                                                                    <button class="btn btn-success btn-block" data-dismiss="modal" onclick='$("#review_down").hide();
                                                                                window.location.href = "<?= HTTP_ROOT; ?>my-booking";'><?php echo __('OK'); ?></button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
