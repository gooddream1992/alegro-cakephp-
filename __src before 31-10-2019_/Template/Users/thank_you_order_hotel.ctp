        ...
        <div class="row">
            <div class="col">
                <div class="pp-contentnonscrol" style="padding-top: 77px;margin-bottom: -69px;">
                    <p><?= __('Your order has been successfully booked! In order for us to proceed with the issuance of itinerary, you must make the payment using the bank reference associated with your order.'); ?><br/><br/><?= __('Please check if there is an email in the inbox, spam or trash of your email address'); ?> "<b><?= __('Pending Order'); ?></b>".<br/><br/> <?= __('In this email we give you the instructions to make the payment via an ATM machine or using the online banking of your bank. Thank you in advance for your choice and we wish you a wonderful stay'); ?></p>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-sm-12 col-md-8 col-lg-12">
                ...
                <div class="hotel-lsting" style="margin: 82px 0px;">
                    ...
                    <div class="hotel-lsting-middle">
                        ...
                        <p style="margin-top: 9px;margin-bottom: -26px !important;"><?= $propertyD->property_size; ?> <?php echo __('Sqm'); ?></p>
                        
                        
                        <p style="margin-bottom: 0 !important;"> <i class="fas fa-users"></i>  <?php
                            echo $this->User->propertyPeople($pro_id, $guest);
                            if ($this->User->propertyPeople($pro_id, $guest) <= 1) {
                                ?> 
                            ...
                            <?php echo $this->User->stateName($pro_id, $guest).','.' '. $this->User->cityName($pro_id, $guest); ?>
                            <br>
                            <?php
                            //pj($aminity);
                            $aminity = $this->User->propertyAmenitiesRoom($room_id);
                            $aminityx = [];
                    ...
                    <div class="hotel-lsting-right">
                        <h6><?php echo $this->User->reviewCount($pro_id); ?> <?= __("reviews"); ?><span><?php echo is_nan($this->User->totalRating($pro_id))?0:$this->User->totalRating($pro_id); ?>/5</span></h6>
                        ...
                        <div class="form-group" style="margin: 16px 9px 0px 0px;">
                            <label>&nbsp;</label>
                            <button type="button" id="submit" class="btn btn-primary hvr-grow btn-fill" style="margin: 16px 0px 10px 0px;line-height: 17px;"><?php echo __('Pending') ?></button>
                        </div>
                    </div>
                </div>
