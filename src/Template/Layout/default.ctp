...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo HTTP_ROOT ?>route/css/style.css" type="text/css">
        <link rel="stylesheet" href="<?php echo HTTP_ROOT ?>dist/css/datepicker.min.css" type="text/css">
        <link rel='stylesheet' href="https://www.alegro.co.ao/css/extranet/bootstrap-table.min.css">
        <link rel='stylesheet' href='https://www.alegro.co.ao/css/extranet/jquery.dataTables.min.css'>
    ...
    <?php if (empty($this->request->session()->read('Auth.User.id'))) { ?>
        <script>
            if (sessionStorage.Url_data != undefined) {
                window.location.replace(sessionStorage.Url_data);
                sessionStorage.Url_data = '';
                sessionStorage.Url_data = undefined;
            } 

           

            console.log(sessionStorage.Url_data);
        </script>
    <?php } ?>
            ...
            <div class="modal-dialog modal-confirm">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-success btn-block" onclick='getClose("accountnot-created")' ><?php echo __('OK'); ?></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="accountnot-error_per" class="modal fade">
            <div class="modal-dialog modal-confirm">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-success btn-block" data-dismiss="modal" style="width: auto;"><?php echo __('Resend Verification Email'); ?></button>
                    </div>
                </div>
            </div>
        </div>
